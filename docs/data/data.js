window.CTA_DASHBOARD_DATA = {
  "generatedAt": "2026-09-15T06:53:54+09:00",
  "latest": {
    ...
    "mtime": "2026-09-15T06:53:54+09:00",
    "size": 4655,
    "body": "CTA 포지셔닝 모니터 — Proxy Trigger 미발생 / neutral/no trigger\n\n① DAILY CTA Proxy Trigger\n```\n기준일         Asset/Index             Value   D1 Δ%   D3      D5      Δ Z    Confirm\n----------  ----------------------  ------  ------  ------  ------  -----  -------\n2026-09-14  SG CTA Trend Index (p…  105.02  -0.30%  +1.55%  +3.60%  -0.35  프록시    \n2026-09-14  SG Short-Term Traders…  31.96   -0.08%  +2.03%  +1.67%  -0.21  프록시    \n2026-09-14  Barclay BTOP50 (proxy…  106.40  -0.37%  +1.56%  +2.23%  -0.62  프록시    \n2026-09-14  DBMF ETF                31.96   -0.08%  +2.03%  +1.67%  -0.21  프록시    \n2026-09-14  KMLM ETF                30.80   -0.66%  +1.10%  +2.79%  -0.80  프록시    \n2026-09-14  Simplify CTA ETF (pro…  30.24   -0.17%  +1.48%  +6.33%  -0.11  프록시    \n```\nTrigger 기준(프록시): D1≤-1% 또는 |Z|≥1, 3D≤-2%, 5D≤-3%.\n\n② Weekly COT Signals (최신 CFTC 기준)\n```\nDate        Asset           Value(Net)  WoW Δ     %         Δ Z    Unwind?  Confirm\n----------  --------------  ----------  --------  --------  -----  -------  -------\n2026-09-08  S&P 500 (ES)    3,881       -165,111  -97.7%    -0.71  ❌        확인     \n2026-09-08  USD Index (DX)  6,186       -947      -13.3%    -0.30  ❌        확인     \n2026-09-08  UST 10Y         -131,355    -132,788  -9266.4%  -1.20  부분 ✔     확인     \n2026-09-08  UST 2Y          110,230     +20,457   +22.8%    +1.58  ❌        확인     \n2026-09-08  UST 5Y          -4,804      +2,441    +33.7%    +0.30  ❌        확인     \n2026-09-08  UST 30Y         -426,360    +437,911  +50.7%    +1.00  ❌        확인     \n```\n표기: Unwind?는 WoW Δ의 하방 Z-score 기준(≤-1.5 ✔, ≤-1.0 부분 ✔).\n\n③ 종합 Alert\n- CTA 프록시 트리거: 미발생 (기준일: 2026-09-15)\n- 국면 판단: neutral/no trigger\n- 실행 포인트: 변동성/추세 훼손 신호(프록시)가 누적되는지 3~5일 창으로 재확인\n- 데이터 메모: S&P 500 (ES): CFTC COT Financial Futures (official zip) 사용 / USD Index (DX): CFTC COT Financial Futures (official zip) 사용\n\n④ 간결한 일일 마켓 모니터(CTA 제외)\n(1) overnight 주요 지수 (프록시)\n```\n기준일         Index               Value     D1      D3      Confirm\n----------  ------------------  --------  ------  ------  -------\n2026-09-11  S&P 500             7656.98   +0.86%  -0.22%  확인     \n2026-09-11  Nasdaq 100          29368.44  +0.91%  -0.47%  확인     \n2026-09-11  Dow                 52573.29  +0.98%  -0.40%  확인     \n2026-09-14  Russell 2000        287.88    -0.35%  -0.95%  프록시    \n2026-09-14  STOXX 600 (proxy:…  89.22     -0.89%  -1.10%  프록시    \n2026-09-14  Nikkei 225          63492.99  -0.81%  -2.53%  확인     \n```\n(2) 금리 (FRED 공개 CSV)\n```\nDate        Rate     Yield  D1      Confirm\n----------  -------  -----  ------  -------\n2026-09-11  UST 2Y   4.63%  +7.0bp  확인     \n2026-09-11  UST 5Y   4.78%  +3.0bp  확인     \n2026-09-11  UST 10Y  4.96%  +1.0bp  확인     \n2026-09-11  UST 30Y  5.35%  -2.0bp  확인     \n```\n\n(3) FX (프록시)\n```\n기준일         FX                  Value   D1      D3      Confirm\n----------  ------------------  ------  ------  ------  -------\n2026-09-11  DXY (proxy: DTWEX…  118.21  +0.11%  +0.25%  확인     \n2026-09-11  EURUSD              1.16    -0.21%  -0.20%  확인     \n2026-09-11  USDJPY              153.71  -0.23%  -0.34%  확인     \n```\n(4) 원자재 (프록시)\n```\n기준일         Commodity          Value   D1      D3      Confirm\n----------  -----------------  ------  ------  ------  -------\n2026-09-09  WTI                97.26   +3.24%  +5.09%  확인     \n2026-09-09  Brent              109.51  +3.19%  +7.11%  확인     \n2026-09-14  Gold (proxy: GLD)  392.78  -1.50%  -2.62%  프록시    \n```\n(5) 주식 변동성 (프록시)\n```\n기준일         Vol  Value  D1       D3      Confirm\n----------  ---  -----  -------  ------  -------\n2026-09-11  VIX  15.84  -11.21%  +0.76%  확인     \n```\n메모: VVIX는 무료/공식 일봉 소스 미연동으로 핵심 coverage 계산에서 제외.\n(6) 미 증시 breadth: 확인 제한(소스 미연동)\n(7) 향후 24~48h 주요 이벤트(공식 일정): 없음/확인 제한\n(8) 실행 가능한 핵심 요약: 아래 Alert 참고\n\n데이터 소스/제약:\n- 일부 지수/ETF/FX/원자재는 무료 공개 소스를 프록시로 사용(리포트 내 Confirm=프록시).\n- COT는 CFTC 공개 데이터 접근 시에만 반영(실패 시 확인 제한).\n- 실시간/공식 소스 미확인 값은 추정처럼 쓰지 않고 ‘확인 제한/프록시’로 표기.",
    "summary": {
      "cta": "- CTA 프록시 트리거: 미발생 (기준일: 2026-09-15)",
  ...
  "reports": [
    ...
    {
      "name": "last_report_20260914.txt",
      "title": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction",
      "date": "2026-09-14",
      "trigger": "재차 발생",
      "regime": "slow deleveraging / exposure reduction",
      "mtime": "2026-09-14T06:53:52+09:00",
      "size": 4709,
      "body": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction\n\n① DAILY CTA Proxy Trigger\n```\n기준일         Asset/Index             Value   D1 Δ%   D3      D5      Δ Z    Confirm\n----------  ----------------------  ------  ------  ------  ------  -----  -------\n2026-09-11  SG CTA Trend Index (p…  105.71  -0.88%  +3.42%  +3.97%  -0.93  프록시    \n2026-09-11  SG Short-Term Traders…  31.99   +0.22%  +2.66%  +1.85%  0.26   프록시    \n2026-09-11  Barclay BTOP50 (proxy…  107.04  -0.05%  +2.81%  +2.61%  -0.17  프록시    \n2026-09-11  DBMF ETF                31.99   +0.22%  +2.66%  +1.85%  0.26   프록시    \n2026-09-11  KMLM ETF                31.01   -0.32%  +2.95%  +3.37%  -0.44  프록시    \n2026-09-11  Simplify CTA ETF (pro…  30.29   -2.54%  +4.59%  +6.69%  -1.47  프록시    \n```\nTrigger 기준(프록시): D1≤-1% 또는 |Z|≥1, 3D≤-2%, 5D≤-3%.\n\n② Weekly COT Signals (최신 CFTC 기준)\n```\nDate        Asset           Value(Net)  WoW Δ     %         Δ Z    Unwind?  Confirm\n----------  --------------  ----------  --------  --------  -----  -------  -------\n2026-09-08  S&P 500 (ES)    3,881       -165,111  -97.7%    -0.71  ❌        확인     \n2026-09-08  USD Index (DX)  6,186       -947      -13.3%    -0.30  ❌        확인     \n2026-09-08  UST 10Y         -131,355    -132,788  -9266.4%  -1.20  부분 ✔     확인     \n2026-09-08  UST 2Y          110,230     +20,457   +22.8%    +1.58  ❌        확인     \n2026-09-08  UST 5Y          -4,804      +2,441    +33.7%    +0.30  ❌        확인     \n2026-09-08  UST 30Y         -426,360    +437,911  +50.7%    +1.00  ❌        확인     \n```\n표기: Unwind?는 WoW Δ의 하방 Z-score 기준(≤-1.5 ✔, ≤-1.0 부분 ✔).\n\n③ 종합 Alert\n- CTA 프록시 트리거: 재차 발생 (기준일: 2026-09-14)\n- 국면 판단: slow deleveraging / exposure reduction\n- 실행 포인트: 변동성/추세 훼손 신호(프록시)가 누적되는지 3~5일 창으로 재확인\n- 데이터 메모: S&P 500 (ES): CFTC COT Financial Futures (official zip) 사용 / USD Index (DX): CFTC COT Financial Futures (official zip) 사용\n\n④ 간결한 일일 마켓 모니터(CTA 제외)\n(1) overnight 주요 지수 (프록시)\n```\n기준일         Index               Value     D1      D3      Confirm\n----------  ------------------  --------  ------  ------  -------\n2026-09-11  S&P 500             7656.98   +0.86%  -0.22%  확인     \n2026-09-11  Nasdaq 100          29368.44  +0.91%  -0.47%  확인     \n2026-09-11  Dow                 52573.29  +0.98%  -0.40%  확인     \n2026-09-11  Russell 2000        288.89    +0.41%  -1.96%  프록시    \n2026-09-11  STOXX 600 (proxy:…  90.02     +0.67%  -1.28%  프록시    \n2026-09-11  Nikkei 225          64011.34  -1.93%  -1.93%  확인     \n```\n(2) 금리 (FRED 공개 CSV)\n```\nDate        Rate     Yield  D1       Confirm\n----------  -------  -----  -------  -------\n2026-09-10  UST 2Y   4.56%  +13.0bp  확인     \n2026-09-10  UST 5Y   4.75%  +14.0bp  확인     \n2026-09-10  UST 10Y  4.95%  +12.0bp  확인     \n2026-09-10  UST 30Y  5.37%  +9.0bp   확인     \n```\n\n(3) FX (프록시)\n```\n기준일         FX                  Value   D1      D3      Confirm\n----------  ------------------  ------  ------  ------  -------\n2026-09-04  DXY (proxy: DTWEX…  118.07  -0.05%  -0.49%  확인     \n2026-09-04  EURUSD              1.16    -0.04%  +0.22%  확인     \n2026-09-04  USDJPY              156.11  +0.46%  -2.45%  확인     \n```\n(4) 원자재 (프록시)\n```\n기준일         Commodity          Value   D1      D3      Confirm\n----------  -----------------  ------  ------  ------  -------\n2026-09-09  WTI                97.26   +3.24%  +5.09%  확인     \n2026-09-09  Brent              109.51  +3.19%  +7.11%  확인     \n2026-09-11  Gold (proxy: GLD)  398.77  +0.61%  -0.24%  프록시    \n```\n(5) 주식 변동성 (프록시)\n```\n기준일         Vol  Value  D1      D3       Confirm\n----------  ---  -----  ------  -------  -------\n2026-09-10  VIX  17.84  +8.38%  +16.60%  확인     \n```\n메모: VVIX는 무료/공식 일봉 소스 미연동으로 핵심 coverage 계산에서 제외.\n(6) 미 증시 breadth: 확인 제한(소스 미연동)\n(7) 향후 24~48h 주요 이벤트(공식 일정): 없음/확인 제한\n(8) 실행 가능한 핵심 요약: 아래 Alert 참고\n\n데이터 소스/제약:\n- 일부 지수/ETF/FX/원자재는 무료 공개 소스를 프록시로 사용(리포트 내 Confirm=프록시).\n- COT는 CFTC 공개 데이터 접근 시에만 반영(실패 시 확인 제한).\n- 실시간/공식 소스 미확인 값은 추정처럼 쓰지 않고 ‘확인 제한/프록시’로 표기.",
      "summary": {
        "cta": "- CTA 프록시 트리거: 재차 발생 (기준일: 2026-09-14)",
    ...
    {
      "name": "last_report_20260913.txt",
      "title": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction",
      "date": "2026-09-13",
      "trigger": "재차 발생",
      "regime": "slow deleveraging / exposure reduction",
      "mtime": "2026-09-13T06:53:52+09:00",
      "size": 4709,
      "body": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction\n\n① DAILY CTA Proxy Trigger\n```\n기준일         Asset/Index             Value   D1 Δ%   D3      D5      Δ Z    Confirm\n----------  ----------------------  ------  ------  ------  ------  -----  -------\n2026-09-11  SG CTA Trend Index (p…  105.71  -0.88%  +3.42%  +3.97%  -0.93  프록시    \n2026-09-11  SG Short-Term Traders…  31.99   +0.22%  +2.66%  +1.85%  0.26   프록시    \n2026-09-11  Barclay BTOP50 (proxy…  107.04  -0.05%  +2.81%  +2.61%  -0.17  프록시    \n2026-09-11  DBMF ETF                31.99   +0.22%  +2.66%  +1.85%  0.26   프록시    \n2026-09-11  KMLM ETF                31.01   -0.32%  +2.95%  +3.37%  -0.44  프록시    \n2026-09-11  Simplify CTA ETF (pro…  30.29   -2.54%  +4.59%  +6.69%  -1.47  프록시    \n```\nTrigger 기준(프록시): D1≤-1% 또는 |Z|≥1, 3D≤-2%, 5D≤-3%.\n\n② Weekly COT Signals (최신 CFTC 기준)\n```\nDate        Asset           Value(Net)  WoW Δ     %         Δ Z    Unwind?  Confirm\n----------  --------------  ----------  --------  --------  -----  -------  -------\n2026-09-08  S&P 500 (ES)    3,881       -165,111  -97.7%    -0.71  ❌        확인     \n2026-09-08  USD Index (DX)  6,186       -947      -13.3%    -0.30  ❌        확인     \n2026-09-08  UST 10Y         -131,355    -132,788  -9266.4%  -1.20  부분 ✔     확인     \n2026-09-08  UST 2Y          110,230     +20,457   +22.8%    +1.58  ❌        확인     \n2026-09-08  UST 5Y          -4,804      +2,441    +33.7%    +0.30  ❌        확인     \n2026-09-08  UST 30Y         -426,360    +437,911  +50.7%    +1.00  ❌        확인     \n```\n표기: Unwind?는 WoW Δ의 하방 Z-score 기준(≤-1.5 ✔, ≤-1.0 부분 ✔).\n\n③ 종합 Alert\n- CTA 프록시 트리거: 재차 발생 (기준일: 2026-09-13)\n- 국면 판단: slow deleveraging / exposure reduction\n- 실행 포인트: 변동성/추세 훼손 신호(프록시)가 누적되는지 3~5일 창으로 재확인\n- 데이터 메모: S&P 500 (ES): CFTC COT Financial Futures (official zip) 사용 / USD Index (DX): CFTC COT Financial Futures (official zip) 사용\n\n④ 간결한 일일 마켓 모니터(CTA 제외)\n(1) overnight 주요 지수 (프록시)\n```\n기준일         Index               Value     D1      D3      Confirm\n----------  ------------------  --------  ------  ------  -------\n2026-09-11  S&P 500             7656.98   +0.86%  -0.22%  확인     \n2026-09-11  Nasdaq 100          29368.44  +0.91%  -0.47%  확인     \n2026-09-11  Dow                 52573.29  +0.98%  -0.40%  확인     \n2026-09-11  Russell 2000        288.89    +0.41%  -1.96%  프록시    \n2026-09-11  STOXX 600 (proxy:…  90.02     +0.67%  -1.28%  프록시    \n2026-09-11  Nikkei 225          64011.34  -1.93%  -1.93%  확인     \n```\n(2) 금리 (FRED 공개 CSV)\n```\nDate        Rate     Yield  D1       Confirm\n----------  -------  -----  -------  -------\n2026-09-10  UST 2Y   4.56%  +13.0bp  확인     \n2026-09-10  UST 5Y   4.75%  +14.0bp  확인     \n2026-09-10  UST 10Y  4.95%  +12.0bp  확인     \n2026-09-10  UST 30Y  5.37%  +9.0bp   확인     \n```\n\n(3) FX (프록시)\n```\n기준일         FX                  Value   D1      D3      Confirm\n----------  ------------------  ------  ------  ------  -------\n2026-09-04  DXY (proxy: DTWEX…  118.07  -0.05%  -0.49%  확인     \n2026-09-04  EURUSD              1.16    -0.04%  +0.22%  확인     \n2026-09-04  USDJPY              156.11  +0.46%  -2.45%  확인     \n```\n(4) 원자재 (프록시)\n```\n기준일         Commodity          Value   D1      D3      Confirm\n----------  -----------------  ------  ------  ------  -------\n2026-09-09  WTI                97.26   +3.24%  +5.09%  확인     \n2026-09-09  Brent              109.51  +3.19%  +7.11%  확인     \n2026-09-11  Gold (proxy: GLD)  398.77  +0.61%  -0.24%  프록시    \n```\n(5) 주식 변동성 (프록시)\n```\n기준일         Vol  Value  D1      D3       Confirm\n----------  ---  -----  ------  -------  -------\n2026-09-10  VIX  17.84  +8.38%  +16.60%  확인     \n```\n메모: VVIX는 무료/공식 일봉 소스 미연동으로 핵심 coverage 계산에서 제외.\n(6) 미 증시 breadth: 확인 제한(소스 미연동)\n(7) 향후 24~48h 주요 이벤트(공식 일정): 없음/확인 제한\n(8) 실행 가능한 핵심 요약: 아래 Alert 참고\n\n데이터 소스/제약:\n- 일부 지수/ETF/FX/원자재는 무료 공개 소스를 프록시로 사용(리포트 내 Confirm=프록시).\n- COT는 CFTC 공개 데이터 접근 시에만 반영(실패 시 확인 제한).\n- 실시간/공식 소스 미확인 값은 추정처럼 쓰지 않고 ‘확인 제한/프록시’로 표기.",
      "summary": {
        "cta": "- CTA 프록시 트리거: 재차 발생 (기준일: 2026-09-13)",
        "regime": "- 국면 판단: slow deleveraging / exposure reduction",
        "network": "정상/미표기",
        "confirmLimited": 4,
        "proxy": 19,
    ...
    {
      "name": "last_report_20260912.txt",
      "title": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction",
      "date": "2026-09-12",
      "trigger": "재차 발생",
      "regime": "slow deleveraging / exposure reduction",
      "mtime": "2026-09-12T06:53:52+09:00",
      "size": 4709,
      "body": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction\n\n① DAILY CTA Proxy Trigger\n```\n기준일         Asset/Index             Value   D1 Δ%   D3      D5      Δ Z    Confirm\n----------  ----------------------  ------  ------  ------  ------  -----  -------\n2026-09-11  SG CTA Trend Index (p…  105.46  -1.12%  +3.17%  +3.73%  -1.16  프록시    \n2026-09-11  SG Short-Term Traders…  31.99   +0.22%  +2.66%  +1.85%  0.26   프록시    \n2026-09-11  Barclay BTOP50 (proxy…  106.68  -0.39%  +2.46%  +2.26%  -0.65  프록시    \n2026-09-11  DBMF ETF                31.99   +0.22%  +2.66%  +1.85%  0.26   프록시    \n2026-09-11  KMLM ETF                30.80   -1.00%  +2.26%  +2.67%  -1.17  프록시    \n2026-09-11  Simplify CTA ETF (pro…  30.28   -2.57%  +4.56%  +6.66%  -1.48  프록시    \n```\nTrigger 기준(프록시): D1≤-1% 또는 |Z|≥1, 3D≤-2%, 5D≤-3%.\n\n② Weekly COT Signals (최신 CFTC 기준)\n```\nDate        Asset           Value(Net)  WoW Δ     %         Δ Z    Unwind?  Confirm\n----------  --------------  ----------  --------  --------  -----  -------  -------\n2026-09-08  S&P 500 (ES)    3,881       -165,111  -97.7%    -0.71  ❌        확인     \n2026-09-08  USD Index (DX)  6,186       -947      -13.3%    -0.30  ❌        확인     \n2026-09-08  UST 10Y         -131,355    -132,788  -9266.4%  -1.20  부분 ✔     확인     \n2026-09-08  UST 2Y          110,230     +20,457   +22.8%    +1.58  ❌        확인     \n2026-09-08  UST 5Y          -4,804      +2,441    +33.7%    +0.30  ❌        확인     \n2026-09-08  UST 30Y         -426,360    +437,911  +50.7%    +1.00  ❌        확인     \n```\n표기: Unwind?는 WoW Δ의 하방 Z-score 기준(≤-1.5 ✔, ≤-1.0 부분 ✔).\n\n③ 종합 Alert\n- CTA 프록시 트리거: 재차 발생 (기준일: 2026-09-12)\n- 국면 판단: slow deleveraging / exposure reduction\n- 실행 포인트: 변동성/추세 훼손 신호(프록시)가 누적되는지 3~5일 창으로 재확인\n- 데이터 메모: S&P 500 (ES): CFTC COT Financial Futures (official zip) 사용 / USD Index (DX): CFTC COT Financial Futures (official zip) 사용\n\n④ 간결한 일일 마켓 모니터(CTA 제외)\n(1) overnight 주요 지수 (프록시)\n```\n기준일         Index               Value     D1      D3      Confirm\n----------  ------------------  --------  ------  ------  -------\n2026-09-10  S&P 500             7591.70   -0.58%  -1.64%  확인     \n2026-09-10  Nasdaq 100          29103.51  -1.08%  -1.49%  확인     \n2026-09-10  Dow                 52064.10  -0.60%  -2.53%  확인     \n2026-09-11  Russell 2000        288.87    +0.41%  -1.97%  프록시    \n2026-09-11  STOXX 600 (proxy:…  90.03     +0.68%  -1.28%  프록시    \n2026-09-11  Nikkei 225          64011.34  -1.93%  -1.93%  확인     \n```\n(2) 금리 (FRED 공개 CSV)\n```\nDate        Rate     Yield  D1       Confirm\n----------  -------  -----  -------  -------\n2026-09-10  UST 2Y   4.56%  +13.0bp  확인     \n2026-09-10  UST 5Y   4.75%  +14.0bp  확인     \n2026-09-10  UST 10Y  4.95%  +12.0bp  확인     \n2026-09-10  UST 30Y  5.37%  +9.0bp   확인     \n```\n\n(3) FX (프록시)\n```\n기준일         FX                  Value   D1      D3      Confirm\n----------  ------------------  ------  ------  ------  -------\n2026-09-04  DXY (proxy: DTWEX…  118.07  -0.05%  -0.49%  확인     \n2026-09-04  EURUSD              1.16    -0.04%  +0.22%  확인     \n2026-09-04  USDJPY              156.11  +0.46%  -2.45%  확인     \n```\n(4) 원자재 (프록시)\n```\n기준일         Commodity          Value   D1      D3      Confirm\n----------  -----------------  ------  ------  ------  -------\n2026-09-09  WTI                97.26   +3.24%  +5.09%  확인     \n2026-09-09  Brent              109.51  +3.19%  +7.11%  확인     \n2026-09-11  Gold (proxy: GLD)  398.60  +0.57%  -0.28%  프록시    \n```\n(5) 주식 변동성 (프록시)\n```\n기준일         Vol  Value  D1      D3       Confirm\n----------  ---  -----  ------  -------  -------\n2026-09-10  VIX  17.84  +8.38%  +16.60%  확인     \n```\n메모: VVIX는 무료/공식 일봉 소스 미연동으로 핵심 coverage 계산에서 제외.\n(6) 미 증시 breadth: 확인 제한(소스 미연동)\n(7) 향후 24~48h 주요 이벤트(공식 일정): 없음/확인 제한\n(8) 실행 가능한 핵심 요약: 아래 Alert 참고\n\n데이터 소스/제약:\n- 일부 지수/ETF/FX/원자재는 무료 공개 소스를 프록시로 사용(리포트 내 Confirm=프록시).\n- COT는 CFTC 공개 데이터 접근 시에만 반영(실패 시 확인 제한).\n- 실시간/공식 소스 미확인 값은 추정처럼 쓰지 않고 ‘확인 제한/프록시’로 표기.",
      "summary": {
        "cta": "- CTA 프록시 트리거: 재차 발생 (기준일: 2026-09-12)",
        "regime": "- 국면 판단: slow deleveraging / exposure reduction",
        "network": "정상/미표기",
        "confirmLimited": 4,
        "proxy": 19,
    ...
    {
      "name": "last_report_20260911.txt",
      "title": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction",
      "date": "2026-09-11",
      "trigger": "재차 발생",
      "regime": "slow deleveraging / exposure reduction",
      "mtime": "2026-09-11T06:53:53+09:00",
      "size": 4675,
      "body": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction\n\n① DAILY CTA Proxy Trigger\n```\n기준일         Asset/Index             Value   D1 Δ%   D3      D5      Δ Z   Confirm\n----------  ----------------------  ------  ------  ------  ------  ----  -------\n2026-09-10  SG CTA Trend Index (p…  108.19  +2.72%  +4.80%  +3.70%  2.68  프록시    \n2026-09-10  SG Short-Term Traders…  31.91   +1.87%  +1.51%  +1.32%  3.05  프록시    \n2026-09-10  Barclay BTOP50 (proxy…  108.23  +1.93%  +2.60%  +1.88%  2.70  프록시    \n2026-09-10  DBMF ETF                31.91   +1.87%  +1.51%  +1.32%  3.05  프록시    \n2026-09-10  KMLM ETF                31.08   +2.00%  +3.70%  +2.44%  2.07  프록시    \n2026-09-10  Simplify CTA ETF (pro…  31.08   +4.30%  +9.28%  +7.39%  2.44  프록시    \n```\nTrigger 기준(프록시): D1≤-1% 또는 |Z|≥1, 3D≤-2%, 5D≤-3%.\n\n② Weekly COT Signals (최신 CFTC 기준)\n```\nDate        Asset           Value(Net)  WoW Δ     %       Δ Z    Unwind?  Confirm\n----------  --------------  ----------  --------  ------  -----  -------  -------\n2026-09-01  S&P 500 (ES)    4,320       -159,133  -97.4%  -0.68  ❌        확인     \n2026-09-01  USD Index (DX)  7,133       -2,056    -22.4%  -0.61  ❌        확인     \n2026-09-01  UST 10Y         -131,487    -1,684    -1.3%   +0.01  ❌        확인     \n2026-09-01  UST 2Y          89,773      +3,757    +4.4%   +0.06  ❌        확인     \n2026-09-01  UST 5Y          -7,245      +1,431    +16.5%  +0.17  ❌        확인     \n2026-09-01  UST 30Y         -423,357    +455,132  +51.8%  +1.04  ❌        확인     \n```\n표기: Unwind?는 WoW Δ의 하방 Z-score 기준(≤-1.5 ✔, ≤-1.0 부분 ✔).\n\n③ 종합 Alert\n- CTA 프록시 트리거: 재차 발생 (기준일: 2026-09-11)\n- 국면 판단: slow deleveraging / exposure reduction\n- 실행 포인트: 변동성/추세 훼손 신호(프록시)가 누적되는지 3~5일 창으로 재확인\n- 데이터 메모: S&P 500 (ES): CFTC COT Financial Futures (official zip) 사용 / USD Index (DX): CFTC COT Financial Futures (official zip) 사용\n\n④ 간결한 일일 마켓 모니터(CTA 제외)\n(1) overnight 주요 지수 (프록시)\n```\n기준일         Index               Value     D1      D3      Confirm\n----------  ------------------  --------  ------  ------  -------\n2026-09-09  S&P 500             7636.36   -0.48%  -1.44%  확인     \n2026-09-09  Nasdaq 100          29421.55  -0.29%  -0.21%  확인     \n2026-09-09  Dow                 52380.66  -0.77%  -2.43%  확인     \n2026-09-10  Russell 2000        287.76    -0.99%  -2.79%  프록시    \n2026-09-10  STOXX 600 (proxy:…  89.41     -0.89%  -2.54%  프록시    \n2026-09-10  Nikkei 225          65270.95  +0.20%  -1.70%  확인     \n```\n(2) 금리 (FRED 공개 CSV)\n```\nDate        Rate     Yield  D1      Confirm\n----------  -------  -----  ------  -------\n2026-09-09  UST 2Y   4.43%  +4.0bp  확인     \n2026-09-09  UST 5Y   4.61%  +4.0bp  확인     \n2026-09-09  UST 10Y  4.83%  +3.0bp  확인     \n2026-09-09  UST 30Y  5.28%  +3.0bp  확인     \n```\n\n(3) FX (프록시)\n```\n기준일         FX                  Value   D1      D3      Confirm\n----------  ------------------  ------  ------  ------  -------\n2026-09-04  DXY (proxy: DTWEX…  118.07  -0.05%  -0.49%  확인     \n2026-09-04  EURUSD              1.16    -0.04%  +0.22%  확인     \n2026-09-04  USDJPY              156.11  +0.46%  -2.45%  확인     \n```\n(4) 원자재 (프록시)\n```\n기준일         Commodity          Value   D1      D3      Confirm\n----------  -----------------  ------  ------  ------  -------\n2026-09-09  WTI                97.26   +3.24%  +5.09%  확인     \n2026-09-09  Brent              109.51  +3.19%  +7.11%  확인     \n2026-09-10  Gold (proxy: GLD)  396.46  -1.71%  -2.53%  프록시    \n```\n(5) 주식 변동성 (프록시)\n```\n기준일         Vol  Value  D1      D3       Confirm\n----------  ---  -----  ------  -------  -------\n2026-09-09  VIX  16.46  +4.71%  +13.28%  확인     \n```\n메모: VVIX는 무료/공식 일봉 소스 미연동으로 핵심 coverage 계산에서 제외.\n(6) 미 증시 breadth: 확인 제한(소스 미연동)\n(7) 향후 24~48h 주요 이벤트(공식 일정): 없음/확인 제한\n(8) 실행 가능한 핵심 요약: 아래 Alert 참고\n\n데이터 소스/제약:\n- 일부 지수/ETF/FX/원자재는 무료 공개 소스를 프록시로 사용(리포트 내 Confirm=프록시).\n- COT는 CFTC 공개 데이터 접근 시에만 반영(실패 시 확인 제한).\n- 실시간/공식 소스 미확인 값은 추정처럼 쓰지 않고 ‘확인 제한/프록시’로 표기.",
      "summary": {
        "cta": "- CTA 프록시 트리거: 재차 발생 (기준일: 2026-09-11)",
        "regime": "- 국면 판단: slow deleveraging / exposure reduction",
        "network": "정상/미표기",
        "confirmLimited": 4,
        "proxy": 19,
    ...
    {
      "name": "last_report_20260910.txt",
      "title": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction",
      "date": "2026-09-10",
      "trigger": "재차 발생",
      "regime": "slow deleveraging / exposure reduction",
      "mtime": "2026-09-10T06:53:53+09:00",
      "size": 4672,
      "body": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction\n\n① DAILY CTA Proxy Trigger\n```\n기준일         Asset/Index             Value   D1 Δ%   D3      D5      Δ Z   Confirm\n----------  ----------------------  ------  ------  ------  ------  ----  -------\n2026-09-09  SG CTA Trend Index (p…  106.47  +1.53%  +2.07%  +0.58%  1.49  프록시    \n2026-09-09  SG Short-Term Traders…  31.32   +0.51%  -0.29%  -0.85%  0.79  프록시    \n2026-09-09  Barclay BTOP50 (proxy…  106.92  +0.82%  +0.62%  -0.39%  1.10  프록시    \n2026-09-09  DBMF ETF                31.32   +0.51%  -0.29%  -0.85%  0.79  프록시    \n2026-09-09  KMLM ETF                30.46   +1.13%  +1.53%  +0.07%  1.14  프록시    \n2026-09-09  Simplify CTA ETF (pro…  29.81   +2.94%  +5.00%  +2.51%  1.68  프록시    \n```\nTrigger 기준(프록시): D1≤-1% 또는 |Z|≥1, 3D≤-2%, 5D≤-3%.\n\n② Weekly COT Signals (최신 CFTC 기준)\n```\nDate        Asset           Value(Net)  WoW Δ     %       Δ Z    Unwind?  Confirm\n----------  --------------  ----------  --------  ------  -----  -------  -------\n2026-09-01  S&P 500 (ES)    4,320       -159,133  -97.4%  -0.68  ❌        확인     \n2026-09-01  USD Index (DX)  7,133       -2,056    -22.4%  -0.61  ❌        확인     \n2026-09-01  UST 10Y         -131,487    -1,684    -1.3%   +0.01  ❌        확인     \n2026-09-01  UST 2Y          89,773      +3,757    +4.4%   +0.06  ❌        확인     \n2026-09-01  UST 5Y          -7,245      +1,431    +16.5%  +0.17  ❌        확인     \n2026-09-01  UST 30Y         -423,357    +455,132  +51.8%  +1.04  ❌        확인     \n```\n표기: Unwind?는 WoW Δ의 하방 Z-score 기준(≤-1.5 ✔, ≤-1.0 부분 ✔).\n\n③ 종합 Alert\n- CTA 프록시 트리거: 재차 발생 (기준일: 2026-09-10)\n- 국면 판단: slow deleveraging / exposure reduction\n- 실행 포인트: 변동성/추세 훼손 신호(프록시)가 누적되는지 3~5일 창으로 재확인\n- 데이터 메모: S&P 500 (ES): CFTC COT Financial Futures (official zip) 사용 / USD Index (DX): CFTC COT Financial Futures (official zip) 사용\n\n④ 간결한 일일 마켓 모니터(CTA 제외)\n(1) overnight 주요 지수 (프록시)\n```\n기준일         Index               Value     D1      D3      Confirm\n----------  ------------------  --------  ------  ------  -------\n2026-09-08  S&P 500             7673.52   -0.58%  +0.09%  확인     \n2026-09-08  Nasdaq 100          29507.70  -0.12%  +1.25%  확인     \n2026-09-08  Dow                 52786.07  -1.18%  -0.52%  확인     \n2026-09-09  Russell 2000        290.65    -1.36%  -1.54%  프록시    \n2026-09-09  STOXX 600 (proxy:…  90.26     -1.02%  -1.61%  프록시    \n2026-09-09  Nikkei 225          65142.78  -0.19%  +0.19%  확인     \n```\n(2) 금리 (FRED 공개 CSV)\n```\nDate        Rate     Yield  D1      Confirm\n----------  -------  -----  ------  -------\n2026-09-08  UST 2Y   4.39%  +2.0bp  확인     \n2026-09-08  UST 5Y   4.57%  +3.0bp  확인     \n2026-09-08  UST 10Y  4.80%  +2.0bp  확인     \n2026-09-08  UST 30Y  5.25%  +1.0bp  확인     \n```\n\n(3) FX (프록시)\n```\n기준일         FX                  Value   D1      D3      Confirm\n----------  ------------------  ------  ------  ------  -------\n2026-09-04  DXY (proxy: DTWEX…  118.07  -0.05%  -0.49%  확인     \n2026-09-04  EURUSD              1.16    -0.04%  +0.22%  확인     \n2026-09-04  USDJPY              156.11  +0.46%  -2.45%  확인     \n```\n(4) 원자재 (프록시)\n```\n기준일         Commodity          Value   D1      D3      Confirm\n----------  -----------------  ------  ------  ------  -------\n2026-09-01  WTI                91.48   +5.11%  +7.86%  확인     \n2026-09-01  Brent              96.02   +6.99%  +9.40%  확인     \n2026-09-09  Gold (proxy: GLD)  403.38  +0.92%  -1.67%  프록시    \n```\n(5) 주식 변동성 (프록시)\n```\n기준일         Vol  Value  D1      D3      Confirm\n----------  ---  -----  ------  ------  -------\n2026-09-08  VIX  15.72  +2.75%  +9.78%  확인     \n```\n메모: VVIX는 무료/공식 일봉 소스 미연동으로 핵심 coverage 계산에서 제외.\n(6) 미 증시 breadth: 확인 제한(소스 미연동)\n(7) 향후 24~48h 주요 이벤트(공식 일정): 없음/확인 제한\n(8) 실행 가능한 핵심 요약: 아래 Alert 참고\n\n데이터 소스/제약:\n- 일부 지수/ETF/FX/원자재는 무료 공개 소스를 프록시로 사용(리포트 내 Confirm=프록시).\n- COT는 CFTC 공개 데이터 접근 시에만 반영(실패 시 확인 제한).\n- 실시간/공식 소스 미확인 값은 추정처럼 쓰지 않고 ‘확인 제한/프록시’로 표기.",
      "summary": {
        "cta": "- CTA 프록시 트리거: 재차 발생 (기준일: 2026-09-10)",
        "regime": "- 국면 판단: slow deleveraging / exposure reduction",
        "network": "정상/미표기",
        "confirmLimited": 4,
        "proxy": 19,
    ...
    {
      "name": "last_report_20260909.txt",
      "title": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction",
      "date": "2026-09-09",
      "trigger": "재차 발생",
      "regime": "slow deleveraging / exposure reduction",
      "mtime": "2026-09-09T06:53:53+09:00",
      "size": 4680,
      "body": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction\n\n① DAILY CTA Proxy Trigger\n```\n기준일         Asset/Index             Value   D1 Δ%   D3      D5      Δ Z    Confirm\n----------  ----------------------  ------  ------  ------  ------  -----  -------\n2026-09-08  SG CTA Trend Index (p…  102.12  +0.49%  -0.57%  +0.84%  0.45   프록시    \n2026-09-08  SG Short-Term Traders…  31.15   -0.92%  -1.11%  -0.73%  -1.57  프록시    \n2026-09-08  Barclay BTOP50 (proxy…  104.10  -0.19%  -0.89%  +0.03%  -0.32  프록시    \n2026-09-08  DBMF ETF                31.15   -0.92%  -1.11%  -0.73%  -1.57  프록시    \n2026-09-08  KMLM ETF                30.14   +0.55%  -0.68%  +0.79%  0.52   프록시    \n2026-09-08  Simplify CTA ETF (pro…  28.96   +1.83%  +0.07%  +2.44%  1.05   프록시    \n```\nTrigger 기준(프록시): D1≤-1% 또는 |Z|≥1, 3D≤-2%, 5D≤-3%.\n\n② Weekly COT Signals (최신 CFTC 기준)\n```\nDate        Asset           Value(Net)  WoW Δ     %       Δ Z    Unwind?  Confirm\n----------  --------------  ----------  --------  ------  -----  -------  -------\n2026-09-01  S&P 500 (ES)    4,320       -159,133  -97.4%  -0.68  ❌        확인     \n2026-09-01  USD Index (DX)  7,133       -2,056    -22.4%  -0.61  ❌        확인     \n2026-09-01  UST 10Y         -131,487    -1,684    -1.3%   +0.01  ❌        확인     \n2026-09-01  UST 2Y          89,773      +3,757    +4.4%   +0.06  ❌        확인     \n2026-09-01  UST 5Y          -7,245      +1,431    +16.5%  +0.17  ❌        확인     \n2026-09-01  UST 30Y         -423,357    +455,132  +51.8%  +1.04  ❌        확인     \n```\n표기: Unwind?는 WoW Δ의 하방 Z-score 기준(≤-1.5 ✔, ≤-1.0 부분 ✔).\n\n③ 종합 Alert\n- CTA 프록시 트리거: 재차 발생 (기준일: 2026-09-09)\n- 국면 판단: slow deleveraging / exposure reduction\n- 실행 포인트: 변동성/추세 훼손 신호(프록시)가 누적되는지 3~5일 창으로 재확인\n- 데이터 메모: S&P 500 (ES): CFTC COT Financial Futures (official zip) 사용 / USD Index (DX): CFTC COT Financial Futures (official zip) 사용\n\n④ 간결한 일일 마켓 모니터(CTA 제외)\n(1) overnight 주요 지수 (프록시)\n```\n기준일         Index               Value     D1      D3      Confirm\n----------  ------------------  --------  ------  ------  -------\n2026-09-04  S&P 500             7718.60   -0.38%  +1.14%  확인     \n2026-09-04  Nasdaq 100          29544.16  +0.21%  +1.61%  확인     \n2026-09-04  Dow                 53414.25  -0.51%  +1.23%  확인     \n2026-09-08  Russell 2000        294.69    -0.45%  +0.23%  프록시    \n2026-09-08  STOXX 600 (proxy:…  91.20     -0.59%  +0.26%  프록시    \n2026-09-08  Nikkei 225          65269.33  -1.70%  +1.64%  확인     \n```\n(2) 금리 (FRED 공개 CSV)\n```\nDate        Rate     Yield  D1      Confirm\n----------  -------  -----  ------  -------\n2026-09-04  UST 2Y   4.37%  +3.0bp  확인     \n2026-09-04  UST 5Y   4.54%  +2.0bp  확인     \n2026-09-04  UST 10Y  4.78%  +1.0bp  확인     \n2026-09-04  UST 30Y  5.24%  -1.0bp  확인     \n```\n\n(3) FX (프록시)\n```\n기준일         FX                  Value   D1      D3      Confirm\n----------  ------------------  ------  ------  ------  -------\n2026-09-04  DXY (proxy: DTWEX…  118.07  -0.05%  -0.49%  확인     \n2026-09-04  EURUSD              1.16    -0.04%  +0.22%  확인     \n2026-09-04  USDJPY              156.11  +0.46%  -2.45%  확인     \n```\n(4) 원자재 (프록시)\n```\n기준일         Commodity          Value   D1      D3      Confirm\n----------  -----------------  ------  ------  ------  -------\n2026-09-01  WTI                91.48   +5.11%  +7.86%  확인     \n2026-09-01  Brent              96.02   +6.99%  +9.40%  확인     \n2026-09-08  Gold (proxy: GLD)  399.68  -1.74%  -0.77%  프록시    \n```\n(5) 주식 변동성 (프록시)\n```\n기준일         Vol  Value  D1      D3      Confirm\n----------  ---  -----  ------  ------  -------\n2026-09-07  VIX  15.30  +5.30%  +0.66%  확인     \n```\n메모: VVIX는 무료/공식 일봉 소스 미연동으로 핵심 coverage 계산에서 제외.\n(6) 미 증시 breadth: 확인 제한(소스 미연동)\n(7) 향후 24~48h 주요 이벤트(공식 일정): 없음/확인 제한\n(8) 실행 가능한 핵심 요약: 아래 Alert 참고\n\n데이터 소스/제약:\n- 일부 지수/ETF/FX/원자재는 무료 공개 소스를 프록시로 사용(리포트 내 Confirm=프록시).\n- COT는 CFTC 공개 데이터 접근 시에만 반영(실패 시 확인 제한).\n- 실시간/공식 소스 미확인 값은 추정처럼 쓰지 않고 ‘확인 제한/프록시’로 표기.",
      "summary": {
        "cta": "- CTA 프록시 트리거: 재차 발생 (기준일: 2026-09-09)",
        "regime": "- 국면 판단: slow deleveraging / exposure reduction",
        "network": "정상/미표기",
        "confirmLimited": 4,
        "proxy": 19,
    ...
    {
      "name": "last_report_20260908.txt",
      "title": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction",
      "date": "2026-09-08",
      "trigger": "재차 발생",
      "regime": "slow deleveraging / exposure reduction",
      "mtime": "2026-09-08T06:53:53+09:00",
      "size": 4680,
      "body": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction\n\n① DAILY CTA Proxy Trigger\n```\n기준일         Asset/Index             Value   D1 Δ%   D3      D5      Δ Z    Confirm\n----------  ----------------------  ------  ------  ------  ------  -----  -------\n2026-09-04  SG CTA Trend Index (p…  102.43  +0.06%  -1.41%  +1.52%  0.03   프록시    \n2026-09-04  SG Short-Term Traders…  31.44   +0.10%  -0.47%  +0.10%  0.09   프록시    \n2026-09-04  Barclay BTOP50 (proxy…  104.96  -0.00%  -1.01%  +0.61%  -0.08  프록시    \n2026-09-04  DBMF ETF                31.44   +0.10%  -0.47%  +0.10%  0.09   프록시    \n2026-09-04  KMLM ETF                29.97   -0.10%  -1.54%  +1.11%  -0.17  프록시    \n2026-09-04  Simplify CTA ETF (pro…  28.44   +0.18%  -2.20%  +3.33%  0.11   프록시    \n```\nTrigger 기준(프록시): D1≤-1% 또는 |Z|≥1, 3D≤-2%, 5D≤-3%.\n\n② Weekly COT Signals (최신 CFTC 기준)\n```\nDate        Asset           Value(Net)  WoW Δ     %       Δ Z    Unwind?  Confirm\n----------  --------------  ----------  --------  ------  -----  -------  -------\n2026-09-01  S&P 500 (ES)    4,320       -159,133  -97.4%  -0.68  ❌        확인     \n2026-09-01  USD Index (DX)  7,133       -2,056    -22.4%  -0.61  ❌        확인     \n2026-09-01  UST 10Y         -131,487    -1,684    -1.3%   +0.01  ❌        확인     \n2026-09-01  UST 2Y          89,773      +3,757    +4.4%   +0.06  ❌        확인     \n2026-09-01  UST 5Y          -7,245      +1,431    +16.5%  +0.17  ❌        확인     \n2026-09-01  UST 30Y         -423,357    +455,132  +51.8%  +1.04  ❌        확인     \n```\n표기: Unwind?는 WoW Δ의 하방 Z-score 기준(≤-1.5 ✔, ≤-1.0 부분 ✔).\n\n③ 종합 Alert\n- CTA 프록시 트리거: 재차 발생 (기준일: 2026-09-08)\n- 국면 판단: slow deleveraging / exposure reduction\n- 실행 포인트: 변동성/추세 훼손 신호(프록시)가 누적되는지 3~5일 창으로 재확인\n- 데이터 메모: S&P 500 (ES): CFTC COT Financial Futures (official zip) 사용 / USD Index (DX): CFTC COT Financial Futures (official zip) 사용\n\n④ 간결한 일일 마켓 모니터(CTA 제외)\n(1) overnight 주요 지수 (프록시)\n```\n기준일         Index               Value     D1      D3      Confirm\n----------  ------------------  --------  ------  ------  -------\n2026-09-04  S&P 500             7718.60   -0.38%  +1.14%  확인     \n2026-09-04  Nasdaq 100          29544.16  +0.21%  +1.61%  확인     \n2026-09-04  Dow                 53414.25  -0.51%  +1.23%  확인     \n2026-09-04  Russell 2000        296.01    +0.28%  +1.87%  프록시    \n2026-09-04  STOXX 600 (proxy:…  91.74     +0.00%  +1.12%  프록시    \n2026-09-07  Nikkei 225          66399.84  +2.12%  +3.22%  확인     \n```\n(2) 금리 (FRED 공개 CSV)\n```\nDate        Rate     Yield  D1      Confirm\n----------  -------  -----  ------  -------\n2026-09-03  UST 2Y   4.34%  -5.0bp  확인     \n2026-09-03  UST 5Y   4.52%  -2.0bp  확인     \n2026-09-03  UST 10Y  4.77%  -2.0bp  확인     \n2026-09-03  UST 30Y  5.25%  -2.0bp  확인     \n```\n\n(3) FX (프록시)\n```\n기준일         FX                  Value   D1      D3      Confirm\n----------  ------------------  ------  ------  ------  -------\n2026-08-28  DXY (proxy: DTWEX…  118.75  +0.33%  +0.44%  확인     \n2026-08-28  EURUSD              1.16    -0.48%  -0.64%  확인     \n2026-08-28  USDJPY              159.97  +0.45%  +0.48%  확인     \n```\n(4) 원자재 (프록시)\n```\n기준일         Commodity          Value   D1      D3      Confirm\n----------  -----------------  ------  ------  ------  -------\n2026-09-01  WTI                91.48   +5.11%  +7.86%  확인     \n2026-09-01  Brent              96.02   +6.99%  +9.40%  확인     \n2026-09-04  Gold (proxy: GLD)  406.77  -0.84%  +2.53%  프록시    \n```\n(5) 주식 변동성 (프록시)\n```\n기준일         Vol  Value  D1      D3      Confirm\n----------  ---  -----  ------  ------  -------\n2026-09-03  VIX  14.32  -5.79%  -4.02%  확인     \n```\n메모: VVIX는 무료/공식 일봉 소스 미연동으로 핵심 coverage 계산에서 제외.\n(6) 미 증시 breadth: 확인 제한(소스 미연동)\n(7) 향후 24~48h 주요 이벤트(공식 일정): 없음/확인 제한\n(8) 실행 가능한 핵심 요약: 아래 Alert 참고\n\n데이터 소스/제약:\n- 일부 지수/ETF/FX/원자재는 무료 공개 소스를 프록시로 사용(리포트 내 Confirm=프록시).\n- COT는 CFTC 공개 데이터 접근 시에만 반영(실패 시 확인 제한).\n- 실시간/공식 소스 미확인 값은 추정처럼 쓰지 않고 ‘확인 제한/프록시’로 표기.",
      "summary": {
        "cta": "- CTA 프록시 트리거: 재차 발생 (기준일: 2026-09-08)",
        "regime": "- 국면 판단: slow deleveraging / exposure reduction",
        "network": "정상/미표기",
        "confirmLimited": 4,
        "proxy": 19,
    ...
    {
      "name": "last_report_20260907.txt",
      "title": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction",
      "date": "2026-09-07",
      "trigger": "재차 발생",
      "regime": "slow deleveraging / exposure reduction",
      "mtime": "2026-09-07T06:53:51+09:00",
      "size": 4680,
      "body": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction\n\n① DAILY CTA Proxy Trigger\n```\n기준일         Asset/Index             Value   D1 Δ%   D3      D5      Δ Z    Confirm\n----------  ----------------------  ------  ------  ------  ------  -----  -------\n2026-09-04  SG CTA Trend Index (p…  102.43  +0.06%  -1.41%  +1.52%  0.03   프록시    \n2026-09-04  SG Short-Term Traders…  31.44   +0.10%  -0.47%  +0.10%  0.09   프록시    \n2026-09-04  Barclay BTOP50 (proxy…  104.96  -0.00%  -1.01%  +0.61%  -0.08  프록시    \n2026-09-04  DBMF ETF                31.44   +0.10%  -0.47%  +0.10%  0.09   프록시    \n2026-09-04  KMLM ETF                29.97   -0.10%  -1.54%  +1.11%  -0.17  프록시    \n2026-09-04  Simplify CTA ETF (pro…  28.44   +0.18%  -2.20%  +3.33%  0.11   프록시    \n```\nTrigger 기준(프록시): D1≤-1% 또는 |Z|≥1, 3D≤-2%, 5D≤-3%.\n\n② Weekly COT Signals (최신 CFTC 기준)\n```\nDate        Asset           Value(Net)  WoW Δ     %       Δ Z    Unwind?  Confirm\n----------  --------------  ----------  --------  ------  -----  -------  -------\n2026-09-01  S&P 500 (ES)    4,320       -159,133  -97.4%  -0.68  ❌        확인     \n2026-09-01  USD Index (DX)  7,133       -2,056    -22.4%  -0.61  ❌        확인     \n2026-09-01  UST 10Y         -131,487    -1,684    -1.3%   +0.01  ❌        확인     \n2026-09-01  UST 2Y          89,773      +3,757    +4.4%   +0.06  ❌        확인     \n2026-09-01  UST 5Y          -7,245      +1,431    +16.5%  +0.17  ❌        확인     \n2026-09-01  UST 30Y         -423,357    +455,132  +51.8%  +1.04  ❌        확인     \n```\n표기: Unwind?는 WoW Δ의 하방 Z-score 기준(≤-1.5 ✔, ≤-1.0 부분 ✔).\n\n③ 종합 Alert\n- CTA 프록시 트리거: 재차 발생 (기준일: 2026-09-07)\n- 국면 판단: slow deleveraging / exposure reduction\n- 실행 포인트: 변동성/추세 훼손 신호(프록시)가 누적되는지 3~5일 창으로 재확인\n- 데이터 메모: S&P 500 (ES): CFTC COT Financial Futures (official zip) 사용 / USD Index (DX): CFTC COT Financial Futures (official zip) 사용\n\n④ 간결한 일일 마켓 모니터(CTA 제외)\n(1) overnight 주요 지수 (프록시)\n```\n기준일         Index               Value     D1      D3      Confirm\n----------  ------------------  --------  ------  ------  -------\n2026-09-04  S&P 500             7718.60   -0.38%  +1.14%  확인     \n2026-09-04  Nasdaq 100          29544.16  +0.21%  +1.61%  확인     \n2026-09-04  Dow                 53414.25  -0.51%  +1.23%  확인     \n2026-09-04  Russell 2000        296.01    +0.28%  +1.87%  프록시    \n2026-09-04  STOXX 600 (proxy:…  91.74     +0.00%  +1.12%  프록시    \n2026-09-04  Nikkei 225          65020.94  +1.26%  -1.80%  확인     \n```\n(2) 금리 (FRED 공개 CSV)\n```\nDate        Rate     Yield  D1      Confirm\n----------  -------  -----  ------  -------\n2026-09-03  UST 2Y   4.34%  -5.0bp  확인     \n2026-09-03  UST 5Y   4.52%  -2.0bp  확인     \n2026-09-03  UST 10Y  4.77%  -2.0bp  확인     \n2026-09-03  UST 30Y  5.25%  -2.0bp  확인     \n```\n\n(3) FX (프록시)\n```\n기준일         FX                  Value   D1      D3      Confirm\n----------  ------------------  ------  ------  ------  -------\n2026-08-28  DXY (proxy: DTWEX…  118.75  +0.33%  +0.44%  확인     \n2026-08-28  EURUSD              1.16    -0.48%  -0.64%  확인     \n2026-08-28  USDJPY              159.97  +0.45%  +0.48%  확인     \n```\n(4) 원자재 (프록시)\n```\n기준일         Commodity          Value   D1      D3      Confirm\n----------  -----------------  ------  ------  ------  -------\n2026-09-01  WTI                91.48   +5.11%  +7.86%  확인     \n2026-09-01  Brent              96.02   +6.99%  +9.40%  확인     \n2026-09-04  Gold (proxy: GLD)  406.77  -0.84%  +2.53%  프록시    \n```\n(5) 주식 변동성 (프록시)\n```\n기준일         Vol  Value  D1      D3      Confirm\n----------  ---  -----  ------  ------  -------\n2026-09-03  VIX  14.32  -5.79%  -4.02%  확인     \n```\n메모: VVIX는 무료/공식 일봉 소스 미연동으로 핵심 coverage 계산에서 제외.\n(6) 미 증시 breadth: 확인 제한(소스 미연동)\n(7) 향후 24~48h 주요 이벤트(공식 일정): 없음/확인 제한\n(8) 실행 가능한 핵심 요약: 아래 Alert 참고\n\n데이터 소스/제약:\n- 일부 지수/ETF/FX/원자재는 무료 공개 소스를 프록시로 사용(리포트 내 Confirm=프록시).\n- COT는 CFTC 공개 데이터 접근 시에만 반영(실패 시 확인 제한).\n- 실시간/공식 소스 미확인 값은 추정처럼 쓰지 않고 ‘확인 제한/프록시’로 표기.",
      "summary": {
        "cta": "- CTA 프록시 트리거: 재차 발생 (기준일: 2026-09-07)",
        "regime": "- 국면 판단: slow deleveraging / exposure reduction",
        "network": "정상/미표기",
        "confirmLimited": 4,
        "proxy": 19,
    ...
    {
      "name": "last_report_20260906.txt",
      "title": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction",
      "date": "2026-09-06",
      "trigger": "재차 발생",
      "regime": "slow deleveraging / exposure reduction",
      "mtime": "2026-09-06T06:53:52+09:00",
      "size": 4680,
      "body": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction\n\n① DAILY CTA Proxy Trigger\n```\n기준일         Asset/Index             Value   D1 Δ%   D3      D5      Δ Z    Confirm\n----------  ----------------------  ------  ------  ------  ------  -----  -------\n2026-09-04  SG CTA Trend Index (p…  102.43  +0.06%  -1.41%  +1.52%  0.03   프록시    \n2026-09-04  SG Short-Term Traders…  31.44   +0.10%  -0.47%  +0.10%  0.09   프록시    \n2026-09-04  Barclay BTOP50 (proxy…  104.96  -0.00%  -1.01%  +0.61%  -0.08  프록시    \n2026-09-04  DBMF ETF                31.44   +0.10%  -0.47%  +0.10%  0.09   프록시    \n2026-09-04  KMLM ETF                29.97   -0.10%  -1.54%  +1.11%  -0.17  프록시    \n2026-09-04  Simplify CTA ETF (pro…  28.44   +0.18%  -2.20%  +3.33%  0.11   프록시    \n```\nTrigger 기준(프록시): D1≤-1% 또는 |Z|≥1, 3D≤-2%, 5D≤-3%.\n\n② Weekly COT Signals (최신 CFTC 기준)\n```\nDate        Asset           Value(Net)  WoW Δ     %       Δ Z    Unwind?  Confirm\n----------  --------------  ----------  --------  ------  -----  -------  -------\n2026-09-01  S&P 500 (ES)    4,320       -159,133  -97.4%  -0.68  ❌        확인     \n2026-09-01  USD Index (DX)  7,133       -2,056    -22.4%  -0.61  ❌        확인     \n2026-09-01  UST 10Y         -131,487    -1,684    -1.3%   +0.01  ❌        확인     \n2026-09-01  UST 2Y          89,773      +3,757    +4.4%   +0.06  ❌        확인     \n2026-09-01  UST 5Y          -7,245      +1,431    +16.5%  +0.17  ❌        확인     \n2026-09-01  UST 30Y         -423,357    +455,132  +51.8%  +1.04  ❌        확인     \n```\n표기: Unwind?는 WoW Δ의 하방 Z-score 기준(≤-1.5 ✔, ≤-1.0 부분 ✔).\n\n③ 종합 Alert\n- CTA 프록시 트리거: 재차 발생 (기준일: 2026-09-06)\n- 국면 판단: slow deleveraging / exposure reduction\n- 실행 포인트: 변동성/추세 훼손 신호(프록시)가 누적되는지 3~5일 창으로 재확인\n- 데이터 메모: S&P 500 (ES): CFTC COT Financial Futures (official zip) 사용 / USD Index (DX): CFTC COT Financial Futures (official zip) 사용\n\n④ 간결한 일일 마켓 모니터(CTA 제외)\n(1) overnight 주요 지수 (프록시)\n```\n기준일         Index               Value     D1      D3      Confirm\n----------  ------------------  --------  ------  ------  -------\n2026-09-04  S&P 500             7718.60   -0.38%  +1.14%  확인     \n2026-09-04  Nasdaq 100          29544.16  +0.21%  +1.61%  확인     \n2026-09-04  Dow                 53414.25  -0.51%  +1.23%  확인     \n2026-09-04  Russell 2000        296.01    +0.28%  +1.87%  프록시    \n2026-09-04  STOXX 600 (proxy:…  91.74     +0.00%  +1.12%  프록시    \n2026-09-04  Nikkei 225          65020.94  +1.26%  -1.80%  확인     \n```\n(2) 금리 (FRED 공개 CSV)\n```\nDate        Rate     Yield  D1      Confirm\n----------  -------  -----  ------  -------\n2026-09-03  UST 2Y   4.34%  -5.0bp  확인     \n2026-09-03  UST 5Y   4.52%  -2.0bp  확인     \n2026-09-03  UST 10Y  4.77%  -2.0bp  확인     \n2026-09-03  UST 30Y  5.25%  -2.0bp  확인     \n```\n\n(3) FX (프록시)\n```\n기준일         FX                  Value   D1      D3      Confirm\n----------  ------------------  ------  ------  ------  -------\n2026-08-28  DXY (proxy: DTWEX…  118.75  +0.33%  +0.44%  확인     \n2026-08-28  EURUSD              1.16    -0.48%  -0.64%  확인     \n2026-08-28  USDJPY              159.97  +0.45%  +0.48%  확인     \n```\n(4) 원자재 (프록시)\n```\n기준일         Commodity          Value   D1      D3      Confirm\n----------  -----------------  ------  ------  ------  -------\n2026-09-01  WTI                91.48   +5.11%  +7.86%  확인     \n2026-09-01  Brent              96.02   +6.99%  +9.40%  확인     \n2026-09-04  Gold (proxy: GLD)  406.77  -0.84%  +2.53%  프록시    \n```\n(5) 주식 변동성 (프록시)\n```\n기준일         Vol  Value  D1      D3      Confirm\n----------  ---  -----  ------  ------  -------\n2026-09-03  VIX  14.32  -5.79%  -4.02%  확인     \n```\n메모: VVIX는 무료/공식 일봉 소스 미연동으로 핵심 coverage 계산에서 제외.\n(6) 미 증시 breadth: 확인 제한(소스 미연동)\n(7) 향후 24~48h 주요 이벤트(공식 일정): 없음/확인 제한\n(8) 실행 가능한 핵심 요약: 아래 Alert 참고\n\n데이터 소스/제약:\n- 일부 지수/ETF/FX/원자재는 무료 공개 소스를 프록시로 사용(리포트 내 Confirm=프록시).\n- COT는 CFTC 공개 데이터 접근 시에만 반영(실패 시 확인 제한).\n- 실시간/공식 소스 미확인 값은 추정처럼 쓰지 않고 ‘확인 제한/프록시’로 표기.",
      "summary": {
        "cta": "- CTA 프록시 트리거: 재차 발생 (기준일: 2026-09-06)",
        "regime": "- 국면 판단: slow deleveraging / exposure reduction",
        "network": "정상/미표기",
        "confirmLimited": 4,
        "proxy": 19,
    ...
    {
      "name": "last_report_20260905.txt",
      "title": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction",
      "date": "2026-09-05",
      "trigger": "재차 발생",
      "regime": "slow deleveraging / exposure reduction",
      "mtime": "2026-09-05T06:53:53+09:00",
      "size": 4680,
      "body": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction\n\n① DAILY CTA Proxy Trigger\n```\n기준일         Asset/Index             Value   D1 Δ%   D3      D5      Δ Z    Confirm\n----------  ----------------------  ------  ------  ------  ------  -----  -------\n2026-09-04  SG CTA Trend Index (p…  102.42  +0.05%  -1.42%  +1.51%  0.02   프록시    \n2026-09-04  SG Short-Term Traders…  31.43   +0.06%  -0.51%  +0.06%  0.04   프록시    \n2026-09-04  Barclay BTOP50 (proxy…  104.92  -0.03%  -1.04%  +0.57%  -0.12  프록시    \n2026-09-04  DBMF ETF                31.43   +0.06%  -0.51%  +0.06%  0.04   프록시    \n2026-09-04  KMLM ETF                29.96   -0.13%  -1.58%  +1.08%  -0.21  프록시    \n2026-09-04  Simplify CTA ETF (pro…  28.45   +0.21%  -2.17%  +3.37%  0.13   프록시    \n```\nTrigger 기준(프록시): D1≤-1% 또는 |Z|≥1, 3D≤-2%, 5D≤-3%.\n\n② Weekly COT Signals (최신 CFTC 기준)\n```\nDate        Asset           Value(Net)  WoW Δ     %       Δ Z    Unwind?  Confirm\n----------  --------------  ----------  --------  ------  -----  -------  -------\n2026-09-01  S&P 500 (ES)    4,320       -159,133  -97.4%  -0.68  ❌        확인     \n2026-09-01  USD Index (DX)  7,133       -2,056    -22.4%  -0.61  ❌        확인     \n2026-09-01  UST 10Y         -131,487    -1,684    -1.3%   +0.01  ❌        확인     \n2026-09-01  UST 2Y          89,773      +3,757    +4.4%   +0.06  ❌        확인     \n2026-09-01  UST 5Y          -7,245      +1,431    +16.5%  +0.17  ❌        확인     \n2026-09-01  UST 30Y         -423,357    +455,132  +51.8%  +1.04  ❌        확인     \n```\n표기: Unwind?는 WoW Δ의 하방 Z-score 기준(≤-1.5 ✔, ≤-1.0 부분 ✔).\n\n③ 종합 Alert\n- CTA 프록시 트리거: 재차 발생 (기준일: 2026-09-05)\n- 국면 판단: slow deleveraging / exposure reduction\n- 실행 포인트: 변동성/추세 훼손 신호(프록시)가 누적되는지 3~5일 창으로 재확인\n- 데이터 메모: S&P 500 (ES): CFTC COT Financial Futures (official zip) 사용 / USD Index (DX): CFTC COT Financial Futures (official zip) 사용\n\n④ 간결한 일일 마켓 모니터(CTA 제외)\n(1) overnight 주요 지수 (프록시)\n```\n기준일         Index               Value     D1      D3      Confirm\n----------  ------------------  --------  ------  ------  -------\n2026-09-03  S&P 500             7747.71   +1.06%  +0.80%  확인     \n2026-09-03  Nasdaq 100          29482.32  +1.16%  +0.09%  확인     \n2026-09-03  Dow                 53686.11  +1.18%  +0.94%  확인     \n2026-09-04  Russell 2000        295.97    +0.26%  +1.86%  프록시    \n2026-09-04  STOXX 600 (proxy:…  91.75     +0.01%  +1.14%  프록시    \n2026-09-04  Nikkei 225          65020.94  +1.26%  -1.80%  확인     \n```\n(2) 금리 (FRED 공개 CSV)\n```\nDate        Rate     Yield  D1      Confirm\n----------  -------  -----  ------  -------\n2026-09-03  UST 2Y   4.34%  -5.0bp  확인     \n2026-09-03  UST 5Y   4.52%  -2.0bp  확인     \n2026-09-03  UST 10Y  4.77%  -2.0bp  확인     \n2026-09-03  UST 30Y  5.25%  -2.0bp  확인     \n```\n\n(3) FX (프록시)\n```\n기준일         FX                  Value   D1      D3      Confirm\n----------  ------------------  ------  ------  ------  -------\n2026-08-28  DXY (proxy: DTWEX…  118.75  +0.33%  +0.44%  확인     \n2026-08-28  EURUSD              1.16    -0.48%  -0.64%  확인     \n2026-08-28  USDJPY              159.97  +0.45%  +0.48%  확인     \n```\n(4) 원자재 (프록시)\n```\n기준일         Commodity          Value   D1      D3      Confirm\n----------  -----------------  ------  ------  ------  -------\n2026-09-01  WTI                91.48   +5.11%  +7.86%  확인     \n2026-09-01  Brent              96.02   +6.99%  +9.40%  확인     \n2026-09-04  Gold (proxy: GLD)  406.84  -0.82%  +2.54%  프록시    \n```\n(5) 주식 변동성 (프록시)\n```\n기준일         Vol  Value  D1      D3      Confirm\n----------  ---  -----  ------  ------  -------\n2026-09-03  VIX  14.32  -5.79%  -4.02%  확인     \n```\n메모: VVIX는 무료/공식 일봉 소스 미연동으로 핵심 coverage 계산에서 제외.\n(6) 미 증시 breadth: 확인 제한(소스 미연동)\n(7) 향후 24~48h 주요 이벤트(공식 일정): 없음/확인 제한\n(8) 실행 가능한 핵심 요약: 아래 Alert 참고\n\n데이터 소스/제약:\n- 일부 지수/ETF/FX/원자재는 무료 공개 소스를 프록시로 사용(리포트 내 Confirm=프록시).\n- COT는 CFTC 공개 데이터 접근 시에만 반영(실패 시 확인 제한).\n- 실시간/공식 소스 미확인 값은 추정처럼 쓰지 않고 ‘확인 제한/프록시’로 표기.",
      "summary": {
        "cta": "- CTA 프록시 트리거: 재차 발생 (기준일: 2026-09-05)",
        "regime": "- 국면 판단: slow deleveraging / exposure reduction",
        "network": "정상/미표기",
        "confirmLimited": 4,
        "proxy": 19,
    ...
    {
      "name": "last_report_20260904.txt",
      "title": "CTA 포지셔닝 모니터 — Proxy Trigger 발생 / slow deleveraging / exposure reduction",
      "date": "2026-09-04",
      "trigger": "발생",
      "regime": "slow deleveraging / exposure reduction",
      "mtime": "2026-09-04T06:53:53+09:00",
      "size": 4694,
      "body": "CTA 포지셔닝 모니터 — Proxy Trigger 발생 / slow deleveraging / exposure reduction\n\n① DAILY CTA Proxy Trigger\n```\n기준일         Asset/Index             Value   D1 Δ%   D3      D5      Δ Z    Confirm\n----------  ----------------------  ------  ------  ------  ------  -----  -------\n2026-09-03  SG CTA Trend Index (p…  102.49  -1.00%  +0.39%  +2.10%  -1.02  프록시    \n2026-09-03  SG Short-Term Traders…  31.40   -0.32%  +0.06%  +0.58%  -0.59  프록시    \n2026-09-03  Barclay BTOP50 (proxy…  105.05  -0.73%  +0.19%  +1.30%  -1.10  프록시    \n2026-09-03  DBMF ETF                31.40   -0.32%  +0.06%  +0.58%  -0.59  프록시    \n2026-09-03  KMLM ETF                30.00   -1.14%  +0.32%  +2.02%  -1.29  프록시    \n2026-09-03  Simplify CTA ETF (pro…  28.49   -1.55%  +0.78%  +3.68%  -0.88  프록시    \n```\nTrigger 기준(프록시): D1≤-1% 또는 |Z|≥1, 3D≤-2%, 5D≤-3%.\n\n② Weekly COT Signals (최신 CFTC 기준)\n```\nDate        Asset           Value(Net)  WoW Δ     %          Δ Z    Unwind?  Confirm\n----------  --------------  ----------  --------  ---------  -----  -------  -------\n2026-08-25  S&P 500 (ES)    5,594       -158,090  -96.6%     -0.68  ❌        확인     \n2026-08-25  USD Index (DX)  9,189       +1,077    +13.3%     +0.22  ❌        확인     \n2026-08-25  UST 10Y         -129,803    -130,917  -11752.0%  -1.19  부분 ✔     확인     \n2026-08-25  UST 2Y          86,016      -1,179    -1.4%      -0.39  ❌        확인     \n2026-08-25  UST 5Y          -8,676      +4,619    +34.7%     +0.60  ❌        확인     \n2026-08-25  UST 30Y         -372,157    +476,831  +56.2%     +1.09  ❌        확인     \n```\n표기: Unwind?는 WoW Δ의 하방 Z-score 기준(≤-1.5 ✔, ≤-1.0 부분 ✔).\n\n③ 종합 Alert\n- CTA 프록시 트리거: 발생 (기준일: 2026-09-04)\n- 국면 판단: slow deleveraging / exposure reduction\n- 실행 포인트: 변동성/추세 훼손 신호(프록시)가 누적되는지 3~5일 창으로 재확인\n- 데이터 메모: S&P 500 (ES): CFTC COT Financial Futures (official zip) 사용 / USD Index (DX): CFTC COT Financial Futures (official zip) 사용\n\n④ 간결한 일일 마켓 모니터(CTA 제외)\n(1) overnight 주요 지수 (프록시)\n```\n기준일         Index               Value     D1      D3      Confirm\n----------  ------------------  --------  ------  ------  -------\n2026-09-02  S&P 500             7666.60   +0.46%  -0.59%  확인     \n2026-09-02  Nasdaq 100          29143.33  +0.23%  -0.99%  확인     \n2026-09-02  Dow                 53061.95  +0.56%  -0.93%  확인     \n2026-09-03  Russell 2000        295.18    +0.40%  +0.43%  프록시    \n2026-09-03  STOXX 600 (proxy:…  91.74     +0.86%  +0.09%  프록시    \n2026-09-03  Nikkei 225          64214.48  -0.17%  -3.16%  확인     \n```\n(2) 금리 (FRED 공개 CSV)\n```\nDate        Rate     Yield  D1      Confirm\n----------  -------  -----  ------  -------\n2026-09-02  UST 2Y   4.39%  +0.0bp  확인     \n2026-09-02  UST 5Y   4.54%  -1.0bp  확인     \n2026-09-02  UST 10Y  4.79%  +0.0bp  확인     \n2026-09-02  UST 30Y  5.27%  +0.0bp  확인     \n```\n\n(3) FX (프록시)\n```\n기준일         FX                  Value   D1      D3      Confirm\n----------  ------------------  ------  ------  ------  -------\n2026-08-28  DXY (proxy: DTWEX…  118.75  +0.33%  +0.44%  확인     \n2026-08-28  EURUSD              1.16    -0.48%  -0.64%  확인     \n2026-08-28  USDJPY              159.97  +0.45%  +0.48%  확인     \n```\n(4) 원자재 (프록시)\n```\n기준일         Commodity          Value   D1      D3      Confirm\n----------  -----------------  ------  ------  ------  -------\n2026-09-01  WTI                91.48   +5.11%  +7.86%  확인     \n2026-09-01  Brent              96.02   +6.99%  +9.40%  확인     \n2026-09-03  Gold (proxy: GLD)  410.22  +1.85%  +0.44%  프록시    \n```\n(5) 주식 변동성 (프록시)\n```\n기준일         Vol  Value  D1      D3      Confirm\n----------  ---  -----  ------  ------  -------\n2026-09-02  VIX  15.20  -6.98%  +5.34%  확인     \n```\n메모: VVIX는 무료/공식 일봉 소스 미연동으로 핵심 coverage 계산에서 제외.\n(6) 미 증시 breadth: 확인 제한(소스 미연동)\n(7) 향후 24~48h 주요 이벤트(공식 일정): 없음/확인 제한\n(8) 실행 가능한 핵심 요약: 아래 Alert 참고\n\n데이터 소스/제약:\n- 일부 지수/ETF/FX/원자재는 무료 공개 소스를 프록시로 사용(리포트 내 Confirm=프록시).\n- COT는 CFTC 공개 데이터 접근 시에만 반영(실패 시 확인 제한).\n- 실시간/공식 소스 미확인 값은 추정처럼 쓰지 않고 ‘확인 제한/프록시’로 표기.",
      "summary": {
        "cta": "- CTA 프록시 트리거: 발생 (기준일: 2026-09-04)",
        "regime": "- 국면 판단: slow deleveraging / exposure reduction",
        "network": "정상/미표기",
        "confirmLimited": 4,
        "proxy": 19,
    ...
    {
      "name": "last_report_20260903.txt",
      "title": "CTA 포지셔닝 모니터 — Proxy Trigger 미발생 / neutral/no trigger",
      "date": "2026-09-03",
      "trigger": "미발생",
      "regime": "neutral/no trigger",
      "mtime": "2026-09-03T06:53:54+09:00",
      "size": 4663,
      "body": "CTA 포지셔닝 모니터 — Proxy Trigger 미발생 / neutral/no trigger\n\n① DAILY CTA Proxy Trigger\n```\n기준일         Asset/Index             Value   D1 Δ%   D3      D5      Δ Z    Confirm\n----------  ----------------------  ------  ------  ------  ------  -----  -------\n2026-09-02  SG CTA Trend Index (p…  102.59  -0.40%  +2.56%  +4.20%  -0.43  프록시    \n2026-09-02  SG Short-Term Traders…  31.50   -0.28%  +0.29%  +1.35%  -0.53  프록시    \n2026-09-02  Barclay BTOP50 (proxy…  105.19  -0.31%  +1.32%  +2.76%  -0.51  프록시    \n2026-09-02  DBMF ETF                31.50   -0.28%  +0.29%  +1.35%  -0.53  프록시    \n2026-09-02  KMLM ETF                30.34   -0.33%  +2.36%  +4.19%  -0.43  프록시    \n2026-09-02  Simplify CTA ETF (pro…  28.91   -0.58%  +5.04%  +7.11%  -0.33  프록시    \n```\nTrigger 기준(프록시): D1≤-1% 또는 |Z|≥1, 3D≤-2%, 5D≤-3%.\n\n② Weekly COT Signals (최신 CFTC 기준)\n```\nDate        Asset           Value(Net)  WoW Δ     %          Δ Z    Unwind?  Confirm\n----------  --------------  ----------  --------  ---------  -----  -------  -------\n2026-08-25  S&P 500 (ES)    5,594       -158,090  -96.6%     -0.68  ❌        확인     \n2026-08-25  USD Index (DX)  9,189       +1,077    +13.3%     +0.22  ❌        확인     \n2026-08-25  UST 10Y         -129,803    -130,917  -11752.0%  -1.19  부분 ✔     확인     \n2026-08-25  UST 2Y          86,016      -1,179    -1.4%      -0.39  ❌        확인     \n2026-08-25  UST 5Y          -8,676      +4,619    +34.7%     +0.60  ❌        확인     \n2026-08-25  UST 30Y         -372,157    +476,831  +56.2%     +1.09  ❌        확인     \n```\n표기: Unwind?는 WoW Δ의 하방 Z-score 기준(≤-1.5 ✔, ≤-1.0 부분 ✔).\n\n③ 종합 Alert\n- CTA 프록시 트리거: 미발생 (기준일: 2026-09-03)\n- 국면 판단: neutral/no trigger\n- 실행 포인트: 변동성/추세 훼손 신호(프록시)가 누적되는지 3~5일 창으로 재확인\n- 데이터 메모: S&P 500 (ES): CFTC COT Financial Futures (official zip) 사용 / USD Index (DX): CFTC COT Financial Futures (official zip) 사용\n\n④ 간결한 일일 마켓 모니터(CTA 제외)\n(1) overnight 주요 지수 (프록시)\n```\n기준일         Index               Value     D1      D3      Confirm\n----------  ------------------  --------  ------  ------  -------\n2026-09-01  S&P 500             7631.47   -0.71%  -1.29%  확인     \n2026-09-01  Nasdaq 100          29077.22  -1.29%  -1.90%  확인     \n2026-09-01  Dow                 52766.88  -0.79%  -1.50%  확인     \n2026-09-02  Russell 2000        294.02    +1.19%  -0.58%  프록시    \n2026-09-02  STOXX 600 (proxy:…  90.99     +0.30%  -1.08%  프록시    \n2026-09-02  Nikkei 225          64325.64  -2.85%  -3.13%  확인     \n```\n(2) 금리 (FRED 공개 CSV)\n```\nDate        Rate     Yield  D1      Confirm\n----------  -------  -----  ------  -------\n2026-09-01  UST 2Y   4.39%  +5.0bp  확인     \n2026-09-01  UST 5Y   4.55%  +6.0bp  확인     \n2026-09-01  UST 10Y  4.79%  +4.0bp  확인     \n2026-09-01  UST 30Y  5.27%  +2.0bp  확인     \n```\n\n(3) FX (프록시)\n```\n기준일         FX                  Value   D1      D3      Confirm\n----------  ------------------  ------  ------  ------  -------\n2026-08-28  DXY (proxy: DTWEX…  118.75  +0.33%  +0.44%  확인     \n2026-08-28  EURUSD              1.16    -0.48%  -0.64%  확인     \n2026-08-28  USDJPY              159.97  +0.45%  +0.48%  확인     \n```\n(4) 원자재 (프록시)\n```\n기준일         Commodity          Value   D1      D3      Confirm\n----------  -----------------  ------  ------  ------  -------\n2026-09-01  WTI                91.48   +5.11%  +7.86%  확인     \n2026-09-01  Brent              96.02   +6.99%  +9.40%  확인     \n2026-09-02  Gold (proxy: GLD)  402.79  +1.52%  -1.49%  프록시    \n```\n(5) 주식 변동성 (프록시)\n```\n기준일         Vol  Value  D1      D3       Confirm\n----------  ---  -----  ------  -------  -------\n2026-09-01  VIX  16.34  +9.52%  +12.61%  확인     \n```\n메모: VVIX는 무료/공식 일봉 소스 미연동으로 핵심 coverage 계산에서 제외.\n(6) 미 증시 breadth: 확인 제한(소스 미연동)\n(7) 향후 24~48h 주요 이벤트(공식 일정): 없음/확인 제한\n(8) 실행 가능한 핵심 요약: 아래 Alert 참고\n\n데이터 소스/제약:\n- 일부 지수/ETF/FX/원자재는 무료 공개 소스를 프록시로 사용(리포트 내 Confirm=프록시).\n- COT는 CFTC 공개 데이터 접근 시에만 반영(실패 시 확인 제한).\n- 실시간/공식 소스 미확인 값은 추정처럼 쓰지 않고 ‘확인 제한/프록시’로 표기.",
      "summary": {
        "cta": "- CTA 프록시 트리거: 미발생 (기준일: 2026-09-03)",
        "regime": "- 국면 판단: neutral/no trigger",
        "network": "정상/미표기",
        "confirmLimited": 4,
        "proxy": 19,
    ...
    {
      "name": "last_report_20260830.txt",
      "title": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction",
      "date": "2026-08-30",
      "trigger": "재차 발생",
      "regime": "slow deleveraging / exposure reduction",
      "mtime": "2026-08-30T06:53:52+09:00",
      "size": 4700,
      "body": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction\n\n① DAILY CTA Proxy Trigger\n```\n기준일         Asset/Index             Value   D1 Δ%   D3      D5      Δ Z   Confirm\n----------  ----------------------  ------  ------  ------  ------  ----  -------\n2026-08-28  SG CTA Trend Index (p…  101.70  +0.53%  +2.01%  -0.84%  0.51  프록시    \n2026-08-28  SG Short-Term Traders…  31.41   +0.61%  +1.29%  +0.13%  0.94  프록시    \n2026-08-28  Barclay BTOP50 (proxy…  105.29  +0.71%  +2.07%  +0.56%  0.94  프록시    \n2026-08-28  DBMF ETF                31.41   +0.61%  +1.29%  +0.13%  0.94  프록시    \n2026-08-28  KMLM ETF                29.64   +0.82%  +2.85%  +0.99%  0.81  프록시    \n2026-08-28  Simplify CTA ETF (pro…  27.52   +0.15%  +1.90%  -3.60%  0.11  프록시    \n```\nTrigger 기준(프록시): D1≤-1% 또는 |Z|≥1, 3D≤-2%, 5D≤-3%.\n\n② Weekly COT Signals (최신 CFTC 기준)\n```\nDate        Asset           Value(Net)  WoW Δ     %          Δ Z    Unwind?  Confirm\n----------  --------------  ----------  --------  ---------  -----  -------  -------\n2026-08-25  S&P 500 (ES)    5,594       -158,090  -96.6%     -0.68  ❌        확인     \n2026-08-25  USD Index (DX)  9,189       +1,077    +13.3%     +0.22  ❌        확인     \n2026-08-25  UST 10Y         -129,803    -130,917  -11752.0%  -1.19  부분 ✔     확인     \n2026-08-25  UST 2Y          86,016      -1,179    -1.4%      -0.39  ❌        확인     \n2026-08-25  UST 5Y          -8,676      +4,619    +34.7%     +0.60  ❌        확인     \n2026-08-25  UST 30Y         -372,157    +476,831  +56.2%     +1.09  ❌        확인     \n```\n표기: Unwind?는 WoW Δ의 하방 Z-score 기준(≤-1.5 ✔, ≤-1.0 부분 ✔).\n\n③ 종합 Alert\n- CTA 프록시 트리거: 재차 발생 (기준일: 2026-08-30)\n- 국면 판단: slow deleveraging / exposure reduction\n- 실행 포인트: 변동성/추세 훼손 신호(프록시)가 누적되는지 3~5일 창으로 재확인\n- 데이터 메모: S&P 500 (ES): CFTC COT Financial Futures (official zip) 사용 / USD Index (DX): CFTC COT Financial Futures (official zip) 사용\n\n④ 간결한 일일 마켓 모니터(CTA 제외)\n(1) overnight 주요 지수 (프록시)\n```\n기준일         Index               Value     D1      D3      Confirm\n----------  ------------------  --------  ------  ------  -------\n2026-08-28  S&P 500             7711.76   -0.25%  +0.45%  확인     \n2026-08-28  Nasdaq 100          29433.43  -0.70%  +0.77%  확인     \n2026-08-28  Dow                 53559.99  -0.02%  -0.03%  확인     \n2026-08-28  Russell 2000        295.75    -1.35%  -1.16%  프록시    \n2026-08-28  STOXX 600 (proxy:…  91.98     -0.33%  -1.30%  프록시    \n2026-08-28  Nikkei 225          66405.56  +0.41%  +0.83%  확인     \n```\n(2) 금리 (FRED 공개 CSV)\n```\nDate        Rate     Yield  D1      Confirm\n----------  -------  -----  ------  -------\n2026-08-27  UST 2Y   4.20%  +1.0bp  확인     \n2026-08-27  UST 5Y   4.38%  +1.0bp  확인     \n2026-08-27  UST 10Y  4.67%  +1.0bp  확인     \n2026-08-27  UST 30Y  5.19%  +1.0bp  확인     \n```\n\n(3) FX (프록시)\n```\n기준일         FX                  Value   D1      D3      Confirm\n----------  ------------------  ------  ------  ------  -------\n2026-08-21  DXY (proxy: DTWEX…  118.06  -0.16%  -0.77%  확인     \n2026-08-21  EURUSD              1.17    +0.04%  +0.90%  확인     \n2026-08-21  USDJPY              158.91  +0.04%  -0.42%  확인     \n```\n(4) 원자재 (프록시)\n```\n기준일         Commodity          Value   D1      D3      Confirm\n----------  -----------------  ------  ------  ------  -------\n2026-08-25  WTI                83.90   -2.83%  -6.52%  확인     \n2026-08-25  Brent              88.24   -4.82%  -6.13%  확인     \n2026-08-28  Gold (proxy: GLD)  408.89  -3.24%  -4.48%  프록시    \n```\n(5) 주식 변동성 (프록시)\n```\n기준일         Vol  Value  D1      D3      Confirm\n----------  ---  -----  ------  ------  -------\n2026-08-27  VIX  14.51  -4.60%  -8.45%  확인     \n```\n메모: VVIX는 무료/공식 일봉 소스 미연동으로 핵심 coverage 계산에서 제외.\n(6) 미 증시 breadth: 확인 제한(소스 미연동)\n(7) 향후 24~48h 주요 이벤트(공식 일정): 없음/확인 제한\n(8) 실행 가능한 핵심 요약: 아래 Alert 참고\n\n데이터 소스/제약:\n- 일부 지수/ETF/FX/원자재는 무료 공개 소스를 프록시로 사용(리포트 내 Confirm=프록시).\n- COT는 CFTC 공개 데이터 접근 시에만 반영(실패 시 확인 제한).\n- 실시간/공식 소스 미확인 값은 추정처럼 쓰지 않고 ‘확인 제한/프록시’로 표기.",
      "summary": {
        "cta": "- CTA 프록시 트리거: 재차 발생 (기준일: 2026-08-30)",
        "regime": "- 국면 판단: slow deleveraging / exposure reduction",
        "network": "정상/미표기",
        "confirmLimited": 4,
        "proxy": 19,
    ...
    {
      "name": "last_report_20260827.txt",
      "title": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction",
      "date": "2026-08-27",
      "trigger": "재차 발생",
      "regime": "slow deleveraging / exposure reduction",
      "mtime": "2026-08-27T06:53:53+09:00",
      "size": 4700,
      "body": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction\n\n① DAILY CTA Proxy Trigger\n```\n기준일         Asset/Index             Value   D1 Δ%   D3      D5      Δ Z   Confirm\n----------  ----------------------  ------  ------  ------  ------  ----  -------\n2026-08-26  SG CTA Trend Index (p…  97.09   +0.39%  -2.42%  -1.08%  0.40  프록시    \n2026-08-26  SG Short-Term Traders…  31.07   +0.21%  -0.94%  +0.44%  0.31  프록시    \n2026-08-26  Barclay BTOP50 (proxy…  102.20  +0.62%  -0.87%  +0.40%  0.83  프록시    \n2026-08-26  DBMF ETF                31.07   +0.21%  -0.94%  +0.44%  0.31  프록시    \n2026-08-26  KMLM ETF                29.11   +1.02%  -0.80%  +0.36%  1.06  프록시    \n2026-08-26  Simplify CTA ETF (pro…  26.99   -0.07%  -5.46%  -4.02%  0.03  프록시    \n```\nTrigger 기준(프록시): D1≤-1% 또는 |Z|≥1, 3D≤-2%, 5D≤-3%.\n\n② Weekly COT Signals (최신 CFTC 기준)\n```\nDate        Asset           Value(Net)  WoW Δ     %          Δ Z    Unwind?  Confirm\n----------  --------------  ----------  --------  ---------  -----  -------  -------\n2026-08-18  S&P 500 (ES)    5,949       -156,657  -96.3%     -0.67  ❌        확인     \n2026-08-18  USD Index (DX)  8,112       +2,340    +40.5%     +0.56  ❌        확인     \n2026-08-18  UST 10Y         -127,128    -128,348  -10520.3%  -1.17  부분 ✔     확인     \n2026-08-18  UST 2Y          87,195      +8,289    +10.5%     +0.46  ❌        확인     \n2026-08-18  UST 5Y          -13,295     +8,142    +38.0%     +1.09  ❌        확인     \n2026-08-18  UST 30Y         -353,477    +507,880  +59.0%     +1.16  ❌        확인     \n```\n표기: Unwind?는 WoW Δ의 하방 Z-score 기준(≤-1.5 ✔, ≤-1.0 부분 ✔).\n\n③ 종합 Alert\n- CTA 프록시 트리거: 재차 발생 (기준일: 2026-08-27)\n- 국면 판단: slow deleveraging / exposure reduction\n- 실행 포인트: 변동성/추세 훼손 신호(프록시)가 누적되는지 3~5일 창으로 재확인\n- 데이터 메모: S&P 500 (ES): CFTC COT Financial Futures (official zip) 사용 / USD Index (DX): CFTC COT Financial Futures (official zip) 사용\n\n④ 간결한 일일 마켓 모니터(CTA 제외)\n(1) overnight 주요 지수 (프록시)\n```\n기준일         Index               Value     D1      D3      Confirm\n----------  ------------------  --------  ------  ------  -------\n2026-08-25  S&P 500             7677.28   +0.32%  +0.47%  확인     \n2026-08-25  Nasdaq 100          29209.23  +0.64%  -0.01%  확인     \n2026-08-25  Dow                 53577.40  +0.30%  +1.55%  확인     \n2026-08-26  Russell 2000        298.96    -0.09%  -0.33%  프록시    \n2026-08-26  STOXX 600 (proxy:…  92.70     -0.53%  -0.02%  프록시    \n2026-08-26  Nikkei 225          66262.16  +0.62%  +0.37%  확인     \n```\n(2) 금리 (FRED 공개 CSV)\n```\nDate        Rate     Yield  D1      Confirm\n----------  -------  -----  ------  -------\n2026-08-25  UST 2Y   4.17%  -7.0bp  확인     \n2026-08-25  UST 5Y   4.35%  -6.0bp  확인     \n2026-08-25  UST 10Y  4.64%  -6.0bp  확인     \n2026-08-25  UST 30Y  5.17%  -6.0bp  확인     \n```\n\n(3) FX (프록시)\n```\n기준일         FX                  Value   D1      D3      Confirm\n----------  ------------------  ------  ------  ------  -------\n2026-08-21  DXY (proxy: DTWEX…  118.06  -0.16%  -0.77%  확인     \n2026-08-21  EURUSD              1.17    +0.04%  +0.90%  확인     \n2026-08-21  USDJPY              158.91  +0.04%  -0.42%  확인     \n```\n(4) 원자재 (프록시)\n```\n기준일         Commodity          Value   D1      D3      Confirm\n----------  -----------------  ------  ------  ------  -------\n2026-08-25  WTI                83.90   -2.83%  -6.52%  확인     \n2026-08-25  Brent              88.24   -4.82%  -6.13%  확인     \n2026-08-26  Gold (proxy: GLD)  421.33  -1.57%  -0.48%  프록시    \n```\n(5) 주식 변동성 (프록시)\n```\n기준일         Vol  Value  D1      D3      Confirm\n----------  ---  -----  ------  ------  -------\n2026-08-25  VIX  15.45  -2.52%  -3.50%  확인     \n```\n메모: VVIX는 무료/공식 일봉 소스 미연동으로 핵심 coverage 계산에서 제외.\n(6) 미 증시 breadth: 확인 제한(소스 미연동)\n(7) 향후 24~48h 주요 이벤트(공식 일정): 없음/확인 제한\n(8) 실행 가능한 핵심 요약: 아래 Alert 참고\n\n데이터 소스/제약:\n- 일부 지수/ETF/FX/원자재는 무료 공개 소스를 프록시로 사용(리포트 내 Confirm=프록시).\n- COT는 CFTC 공개 데이터 접근 시에만 반영(실패 시 확인 제한).\n- 실시간/공식 소스 미확인 값은 추정처럼 쓰지 않고 ‘확인 제한/프록시’로 표기.",
      "summary": {
        "cta": "- CTA 프록시 트리거: 재차 발생 (기준일: 2026-08-27)",
        "regime": "- 국면 판단: slow deleveraging / exposure reduction",
        "network": "정상/미표기",
        "confirmLimited": 4,
        "proxy": 19,
    ...
    {
      "name": "last_report_20260826.txt",
      "title": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction",
      "date": "2026-08-26",
      "trigger": "재차 발생",
      "regime": "slow deleveraging / exposure reduction",
      "mtime": "2026-08-26T06:53:52+09:00",
      "size": 4708,
      "body": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction\n\n① DAILY CTA Proxy Trigger\n```\n기준일         Asset/Index             Value   D1 Δ%   D3      D5      Δ Z    Confirm\n----------  ----------------------  ------  ------  ------  ------  -----  -------\n2026-08-25  SG CTA Trend Index (p…  97.15   -1.74%  -2.49%  -2.09%  -1.69  프록시    \n2026-08-25  SG Short-Term Traders…  31.00   -0.78%  -0.50%  -0.85%  -1.34  프록시    \n2026-08-25  Barclay BTOP50 (proxy…  101.90  -1.02%  -1.11%  -1.49%  -1.46  프록시    \n2026-08-25  DBMF ETF                31.00   -0.78%  -0.50%  -0.85%  -1.34  프록시    \n2026-08-25  KMLM ETF                28.73   -1.25%  -1.73%  -2.13%  -1.36  프록시    \n2026-08-25  Simplify CTA ETF (pro…  27.00   -3.19%  -5.20%  -3.33%  -1.75  프록시    \n```\nTrigger 기준(프록시): D1≤-1% 또는 |Z|≥1, 3D≤-2%, 5D≤-3%.\n\n② Weekly COT Signals (최신 CFTC 기준)\n```\nDate        Asset           Value(Net)  WoW Δ     %          Δ Z    Unwind?  Confirm\n----------  --------------  ----------  --------  ---------  -----  -------  -------\n2026-08-18  S&P 500 (ES)    5,949       -156,657  -96.3%     -0.67  ❌        확인     \n2026-08-18  USD Index (DX)  8,112       +2,340    +40.5%     +0.56  ❌        확인     \n2026-08-18  UST 10Y         -127,128    -128,348  -10520.3%  -1.17  부분 ✔     확인     \n2026-08-18  UST 2Y          87,195      +8,289    +10.5%     +0.46  ❌        확인     \n2026-08-18  UST 5Y          -13,295     +8,142    +38.0%     +1.09  ❌        확인     \n2026-08-18  UST 30Y         -353,477    +507,880  +59.0%     +1.16  ❌        확인     \n```\n표기: Unwind?는 WoW Δ의 하방 Z-score 기준(≤-1.5 ✔, ≤-1.0 부분 ✔).\n\n③ 종합 Alert\n- CTA 프록시 트리거: 재차 발생 (기준일: 2026-08-26)\n- 국면 판단: slow deleveraging / exposure reduction\n- 실행 포인트: 변동성/추세 훼손 신호(프록시)가 누적되는지 3~5일 창으로 재확인\n- 데이터 메모: S&P 500 (ES): CFTC COT Financial Futures (official zip) 사용 / USD Index (DX): CFTC COT Financial Futures (official zip) 사용\n\n④ 간결한 일일 마켓 모니터(CTA 제외)\n(1) overnight 주요 지수 (프록시)\n```\n기준일         Index               Value     D1      D3      Confirm\n----------  ------------------  --------  ------  ------  -------\n2026-08-24  S&P 500             7652.86   -0.28%  -0.72%  확인     \n2026-08-24  Nasdaq 100          29023.18  -0.97%  -1.37%  확인     \n2026-08-24  Dow                 53417.16  +0.26%  -0.09%  확인     \n2026-08-25  Russell 2000        299.28    +0.44%  +0.54%  프록시    \n2026-08-25  STOXX 600 (proxy:…  93.18     +0.62%  +1.27%  프록시    \n2026-08-25  Nikkei 225          65856.43  +0.50%  -0.54%  확인     \n```\n(2) 금리 (FRED 공개 CSV)\n```\nDate        Rate     Yield  D1      Confirm\n----------  -------  -----  ------  -------\n2026-08-24  UST 2Y   4.24%  +0.0bp  확인     \n2026-08-24  UST 5Y   4.41%  -2.0bp  확인     \n2026-08-24  UST 10Y  4.70%  -4.0bp  확인     \n2026-08-24  UST 30Y  5.23%  -4.0bp  확인     \n```\n\n(3) FX (프록시)\n```\n기준일         FX                  Value   D1      D3      Confirm\n----------  ------------------  ------  ------  ------  -------\n2026-08-21  DXY (proxy: DTWEX…  118.06  -0.16%  -0.77%  확인     \n2026-08-21  EURUSD              1.17    +0.04%  +0.90%  확인     \n2026-08-21  USDJPY              158.91  +0.04%  -0.42%  확인     \n```\n(4) 원자재 (프록시)\n```\n기준일         Commodity          Value   D1      D3      Confirm\n----------  -----------------  ------  ------  ------  -------\n2026-08-18  WTI                86.48   +0.51%  +4.48%  확인     \n2026-08-18  Brent              95.29   +3.09%  +3.54%  확인     \n2026-08-25  Gold (proxy: GLD)  428.07  +0.32%  +3.09%  프록시    \n```\n(5) 주식 변동성 (프록시)\n```\n기준일         Vol  Value  D1      D3      Confirm\n----------  ---  -----  ------  ------  -------\n2026-08-24  VIX  15.85  +4.76%  +6.45%  확인     \n```\n메모: VVIX는 무료/공식 일봉 소스 미연동으로 핵심 coverage 계산에서 제외.\n(6) 미 증시 breadth: 확인 제한(소스 미연동)\n(7) 향후 24~48h 주요 이벤트(공식 일정): 없음/확인 제한\n(8) 실행 가능한 핵심 요약: 아래 Alert 참고\n\n데이터 소스/제약:\n- 일부 지수/ETF/FX/원자재는 무료 공개 소스를 프록시로 사용(리포트 내 Confirm=프록시).\n- COT는 CFTC 공개 데이터 접근 시에만 반영(실패 시 확인 제한).\n- 실시간/공식 소스 미확인 값은 추정처럼 쓰지 않고 ‘확인 제한/프록시’로 표기.",
      "summary": {
        "cta": "- CTA 프록시 트리거: 재차 발생 (기준일: 2026-08-26)",
        "regime": "- 국면 판단: slow deleveraging / exposure reduction",
        "network": "정상/미표기",
        "confirmLimited": 4,
        "proxy": 19,
    ...
    {
      "name": "last_report_20260825.txt",
      "title": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction",
      "date": "2026-08-25",
      "trigger": "재차 발생",
      "regime": "slow deleveraging / exposure reduction",
      "mtime": "2026-08-25T06:53:54+09:00",
      "size": 4708,
      "body": "CTA 포지셔닝 모니터 — Proxy Trigger 재차 발생 / slow deleveraging / exposure reduction\n\n① DAILY CTA Proxy Trigger\n```\n기준일         Asset/Index             Value   D1 Δ%   D3      D5      Δ Z    Confirm\n----------  ----------------------  ------  ------  ------  ------  -----  -------\n2026-08-24  SG CTA Trend Index (p…  100.81  -1.19%  +0.16%  -0.69%  -1.17  프록시    \n2026-08-24  SG Short-Term Traders…  31.25   -0.40%  +0.99%  -0.94%  -0.72  프록시    \n2026-08-24  Barclay BTOP50 (proxy…  103.74  -0.64%  +0.63%  -1.08%  -0.96  프록시    \n2026-08-24  DBMF ETF                31.25   -0.40%  +0.99%  -0.94%  -0.72  프록시    \n2026-08-24  KMLM ETF                29.09   -0.89%  +0.28%  -1.22%  -0.99  프록시    \n2026-08-24  Simplify CTA ETF (pro…  27.90   -2.28%  -0.78%  +0.07%  -1.24  프록시    \n```\nTrigger 기준(프록시): D1≤-1% 또는 |Z|≥1, 3D≤-2%, 5D≤-3%.\n\n② Weekly COT Signals (최신 CFTC 기준)\n```\nDate        Asset           Value(Net)  WoW Δ     %          Δ Z    Unwind?  Confirm\n----------  --------------  ----------  --------  ---------  -----  -------  -------\n2026-08-18  S&P 500 (ES)    5,949       -156,657  -96.3%     -0.67  ❌        확인     \n2026-08-18  USD Index (DX)  8,112       +2,340    +40.5%     +0.56  ❌        확인     \n2026-08-18  UST 10Y         -127,128    -128,348  -10520.3%  -1.17  부분 ✔     확인     \n2026-08-18  UST 2Y          87,195      +8,289    +10.5%     +0.46  ❌        확인     \n2026-08-18  UST 5Y          -13,295     +8,142    +38.0%     +1.09  ❌        확인     \n2026-08-18  UST 30Y         -353,477    +507,880  +59.0%     +1.16  ❌        확인     \n```\n표기: Unwind?는 WoW Δ의 하방 Z-score 기준(≤-1.5 ✔, ≤-1.0 부분 ✔).\n\n③ 종합 Alert\n- CTA 프록시 트리거: 재차 발생 (기준일: 2026-08-25)\n- 국면 판단: slow deleveraging / exposure reduction\n- 실행 포인트: 변동성/추세 훼손 신호(프록시)가 누적되는지 3~5일 창으로 재확인\n- 데이터 메모: S&P 500 (ES): CFTC COT Financial Futures (official zip) 사용 / USD Index (DX): CFTC COT Financial Futures (official zip) 사용\n\n④ 간결한 일일 마켓 모니터(CTA 제외)\n(1) overnight 주요 지수 (프록시)\n```\n기준일         Index               Value     D1      D3      Confirm\n----------  ------------------  --------  ------  ------  -------\n2026-08-21  S&P 500             7674.37   +0.43%  -0.23%  확인     \n2026-08-21  Nasdaq 100          29308.86  +0.33%  -0.62%  확인     \n2026-08-21  Dow                 53277.01  +0.98%  -0.12%  확인     \n2026-08-24  Russell 2000        297.97    -0.66%  -1.24%  프록시    \n2026-08-24  STOXX 600 (proxy:…  92.62     -0.11%  +0.42%  프록시    \n2026-08-24  Nikkei 225          65528.09  -0.74%  +0.31%  확인     \n```\n(2) 금리 (FRED 공개 CSV)\n```\nDate        Rate     Yield  D1      Confirm\n----------  -------  -----  ------  -------\n2026-08-21  UST 2Y   4.24%  +5.0bp  확인     \n2026-08-21  UST 5Y   4.43%  +4.0bp  확인     \n2026-08-21  UST 10Y  4.74%  +5.0bp  확인     \n2026-08-21  UST 30Y  5.27%  +4.0bp  확인     \n```\n\n(3) FX (프록시)\n```\n기준일         FX                  Value   D1      D3      Confirm\n----------  ------------------  ------  ------  ------  -------\n2026-08-21  DXY (proxy: DTWEX…  118.06  -0.16%  -0.77%  확인     \n2026-08-21  EURUSD              1.17    +0.04%  +0.90%  확인     \n2026-08-21  USDJPY              158.91  +0.04%  -0.42%  확인     \n```\n(4) 원자재 (프록시)\n```\n기준일         Commodity          Value   D1      D3      Confirm\n----------  -----------------  ------  ------  ------  -------\n2026-08-18  WTI                86.48   +0.51%  +4.48%  확인     \n2026-08-18  Brent              95.29   +3.09%  +3.54%  확인     \n2026-08-24  Gold (proxy: GLD)  426.72  +0.79%  +3.11%  프록시    \n```\n(5) 주식 변동성 (프록시)\n```\n기준일         Vol  Value  D1      D3      Confirm\n----------  ---  -----  ------  ------  -------\n2026-08-21  VIX  15.13  -5.50%  -4.48%  확인     \n```\n메모: VVIX는 무료/공식 일봉 소스 미연동으로 핵심 coverage 계산에서 제외.\n(6) 미 증시 breadth: 확인 제한(소스 미연동)\n(7) 향후 24~48h 주요 이벤트(공식 일정): 없음/확인 제한\n(8) 실행 가능한 핵심 요약: 아래 Alert 참고\n\n데이터 소스/제약:\n- 일부 지수/ETF/FX/원자재는 무료 공개 소스를 프록시로 사용(리포트 내 Confirm=프록시).\n- COT는 CFTC 공개 데이터 접근 시에만 반영(실패 시 확인 제한).\n- 실시간/공식 소스 미확인 값은 추정처럼 쓰지 않고 ‘확인 제한/프록시’로 표기.",
      "summary": {
        "cta": "- CTA 프록시 트리거: 재차 발생 (기준일: 2026-08-25)",
        "regime": "- 국면 판단: slow deleveraging / exposure reduction",
        "network": "정상/미표기",
        "confirmLimited": 4,
        "proxy": 19,
